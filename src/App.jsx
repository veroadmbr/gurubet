...
const ESPORTES = {
  futebol: { label:'Futebol', items:[
    // ── 21/03 Premier League (encerrados hoje) — status upcoming para não mostrar live errado ──
    { id:'f1', status:'upcoming', startTime:'2026-03-21T12:30:00Z', statusLabel:'Hoje · PL Jornada 31 · FT', competition:'Premier League · Jornada 31', title:'Brighton × Liverpool', bettvPick:'Liverpool', bettvConf:57, bettvReason:'Liverpool 3º (63pts). Salah em grande fase. Brighton em casa mas Reds favoritos fora.', home:{name:'Brighton', logo:'brighton', sub:'6º · 53pts', pct:29}, away:{name:'Liverpool', logo:'liverpool', sub:'3º · 66pts', pct:57}, draw:14 },
    { id:'f2', status:'upcoming', startTime:'2026-03-21T15:00:00Z', statusLabel:'Hoje · PL Jornada 31 · FT', competition:'Premier League · Jornada 31', title:'Fulham × Burnley', bettvPick:'Fulham', bettvConf:61, bettvReason:'Fulham em casa sólido. Burnley 20º na zona de rebaixamento.', home:{name:'Fulham', logo:null, sub:'8º · 43pts', pct:60}, away:{name:'Burnley', logo:null, sub:'20º · 18pts', pct:18}, draw:22 },
    { id:'f3', status:'upcoming', startTime:'2026-03-21T17:30:00Z', statusLabel:'Hoje · PL Jornada 31 · FT', competition:'Premier League · Jornada 31', title:'Everton × Chelsea', bettvPick:'Chelsea', bettvConf:54, bettvReason:'Chelsea 4º (62pts). Palmer decisivo. Everton 13º irregular em casa.', home:{name:'Everton', logo:'everton', sub:'13º · 31pts', pct:28}, away:{name:'Chelsea', logo:'chelsea', sub:'4º · 62pts', pct:55}, draw:17 },
    // ── AO VIVO AGORA: Leeds × Brentford (20:00 GMT = 17:00 BRT, ainda em andamento) ──
    { id:'f4', status:'live', startTime:'2026-03-21T20:00:00Z', statusLabel:'AO VIVO · PL Jornada 31', competition:'Premier League · Jornada 31', title:'Leeds × Brentford', bettvPick:'Brentford', bettvConf:49, bettvReason:'Leeds 18º luta contra rebaixamento em casa. Brentford 10º mais estável.', home:{name:'Leeds United', logo:null, sub:'18º · 22pts', pct:33}, away:{name:'Brentford', logo:null, sub:'10º · 42pts', pct:45}, draw:22 },
    // ── 22/03 Premier League (amanhã) ──
    { id:'f5', status:'upcoming', startTime:'2026-03-22T12:00:00Z', statusLabel:'Amanhã · 09h · St. James Park', competition:'Premier League · Jornada 31', title:'Newcastle × Sunderland', bettvPick:'Newcastle', bettvConf:68, bettvReason:'Newcastle 5º em casa. Sunderland promovido, 19º. Diferença de qualidade grande.', home:{name:'Newcastle', logo:'newcastle', sub:'5º · 55pts', pct:67}, away:{name:'Sunderland', logo:null, sub:'19º · 19pts', pct:14}, draw:19 },
    { id:'f6', status:'upcoming', startTime:'2026-03-22T14:15:00Z', statusLabel:'Amanhã · 11h15 · Villa Park', competition:'Premier League · Jornada 31', title:'Aston Villa × West Ham', bettvPick:'Aston Villa', bettvConf:58, bettvReason:'Villa 7º busca top 4. West Ham 15º oscilando. Watkins artilheiro.', home:{name:'Aston Villa', logo:'astonvilla', sub:'7º · 48pts', pct:57}, away:{name:'West Ham', logo:null, sub:'15º · 28pts', pct:22}, draw:21 },
    { id:'f7', status:'upcoming', startTime:'2026-03-22T14:15:00Z', statusLabel:'Amanhã · 11h15 · Tottenham Hotspur', competition:'Premier League · Jornada 31', title:'Tottenham × Nottm Forest', bettvPick:'Tottenham', bettvConf:55, bettvReason:'Tottenham 8º em casa. Forest 11º. Son liderando os Spurs.', home:{name:'Tottenham', logo:'tottenham', sub:'8º · 46pts', pct:54}, away:{name:'Nottm Forest', logo:null, sub:'11º · 40pts', pct:24}, draw:22 },
    // ── La Liga 22/03 ──
    { id:'f8', status:'upcoming', startTime:'2026-03-22T21:00:00+01:00', statusLabel:'Amanhã · 17h · Bernabéu', competition:'La Liga · Jornada 29', title:'Real Madrid × Barcelona', bettvPick:'Real Madrid', bettvConf:48, bettvReason:'El Clásico no Bernabéu. Real 2º (68pts) vs Barça 1º (70pts). Mbappé vs Yamal.', home:{name:'Real Madrid', logo:'realmadrid', sub:'2º · 68pts', pct:46}, away:{name:'Barcelona', logo:'barcelona', sub:'1º · 70pts', pct:36}, draw:18 },
    // ── Brasileirão começa em Abril 2026 ──
    { id:'f9', status:'upcoming', startTime:'2026-04-05T16:00:00-03:00', statusLabel:'05/04 · 16h · Morumbis', competition:'Brasileirão Série A 2026 · Rd 1', title:'São Paulo × Palmeiras', bettvPick:'Palmeiras', bettvConf:55, bettvReason:'Palmeiras favorito no início de temporada. SP em reconstrução.', home:{name:'São Paulo', logo:'saopaulo', sub:'Campeonato Paulista', pct:33}, away:{name:'Palmeiras', logo:'palmeiras', sub:'Campeonato Paulista', pct:48}, draw:19 },
    { id:'f10', status:'upcoming', startTime:'2026-04-05T18:30:00-03:00', statusLabel:'05/04 · 18h30 · Neo Química', competition:'Brasileirão Série A 2026 · Rd 1', title:'Corinthians × Flamengo', bettvPick:'Flamengo', bettvConf:52, bettvReason:'Flamengo elenco mais completo. Corinthians em processo de reestruturação.', home:{name:'Corinthians', logo:'corinthians', sub:'Série A 2026', pct:29}, away:{name:'Flamengo', logo:'flamengo', sub:'Série A 2026', pct:48}, draw:23 },
    // ── Champions League QF Abril ──
    { id:'f11', status:'upcoming', startTime:'2026-04-07T20:00:00+02:00', statusLabel:'07/04 · 15h · Etihad', competition:'Champions League · Quartas-final', title:'Man. City × PSG', bettvPick:'Man. City', bettvConf:52, bettvReason:'City em casa. 5 finais da UCL em 6 anos. PSG eliminado por City em 2021.', home:{name:'Man. City', logo:'mancity', sub:'QF · ING', pct:50}, away:{name:'PSG', logo:'psg', sub:'QF · FRA', pct:30}, draw:20 },
    { id:'f12', status:'upcoming', startTime:'2026-04-08T20:00:00+02:00', statusLabel:'08/04 · 15h · Bernabéu', competition:'Champions League · Quartas-final', title:'Real Madrid × Inter Milão', bettvPick:'Real Madrid', bettvConf:54, bettvReason:'Real 15 títulos UCL. Mbappé vs Lautaro — duelo de artilheiros.', home:{name:'Real Madrid', logo:'realmadrid', sub:'QF · ESP', pct:52}, away:{name:'Inter Milão', logo:'intermilan', sub:'QF · ITA', pct:28}, draw:20 },
  ]},
  basquete: { label:'Basquete', items:[
    // ── NBA hoje 21/03 — dados reais SportRadar ──
    { id:'b1', status:'upcoming', startTime:'2026-03-21T21:00:00Z', statusLabel:'Hoje · 18h · Capital One Arena', competition:'NBA · Temporada Regular', title:'Washington × OKC Thunder', bettvPick:'OKC Thunder', bettvConf:92, bettvReason:'OKC 95.8% SportRadar. Líder absoluto do Oeste vs pior time da liga.', home:{name:'Washington', logo:null, sub:'Conf. Leste · Último', pct:4}, away:{name:'OKC Thunder', logo:'okc', sub:'1º Oeste', pct:93}, draw:3 },
    { id:'b2', status:'upcoming', startTime:'2026-03-21T23:00:00Z', statusLabel:'Hoje · 20h · Kaseya Center', competition:'NBA · Temporada Regular', title:'Orlando × LA Lakers', bettvPick:'LA Lakers', bettvConf:55, bettvReason:'Lakers 59.9% SportRadar. LeBron e AD dominam. Orlando perdeu últimos 4.', home:{name:'Orlando', logo:null, sub:'Conf. Leste', pct:40}, away:{name:'LA Lakers', logo:'lakers', sub:'Conf. Oeste', pct:55}, draw:5 },
    { id:'b3', status:'upcoming', startTime:'2026-03-21T23:00:00Z', statusLabel:'Hoje · 20h · Smoothie King', competition:'NBA · Temporada Regular', title:'New Orleans × Cleveland', bettvPick:'Cleveland', bettvConf:58, bettvReason:'Cleveland 63.4% SportRadar. Em 3V seguidas. Pelicans irregulares.', home:{name:'New Orleans', logo:null, sub:'Conf. Leste', pct:37}, away:{name:'Cleveland', logo:'cavaliers', sub:'3º Leste', pct:58}, draw:5 },
    { id:'b4', status:'upcoming', startTime:'2026-03-22T00:00:00Z', statusLabel:'Hoje · 21h · Toyota Center', competition:'NBA · Temporada Regular', title:'Houston × Miami', bettvPick:'Houston', bettvConf:53, bettvReason:'Houston 54.7% SportRadar. 5 vitórias seguidas em casa.', home:{name:'Houston', logo:'rockets', sub:'Conf. Oeste', pct:54}, away:{name:'Miami', logo:'heat', sub:'Conf. Leste', pct:43}, draw:3 },
    { id:'b5', status:'upcoming', startTime:'2026-03-22T00:00:00Z', statusLabel:'Hoje · 21h · AT&T Center', competition:'NBA · Temporada Regular', title:'San Antonio × Indiana', bettvPick:'San Antonio', bettvConf:88, bettvReason:'Spurs 93.4% SportRadar. Wembanyama dominante. Pacers sem Haliburton.', home:{name:'San Antonio', logo:null, sub:'Conf. Oeste', pct:89}, away:{name:'Indiana', logo:null, sub:'Conf. Leste', pct:7}, draw:4 },
    { id:'b6', status:'upcoming', startTime:'2026-03-22T00:00:00Z', statusLabel:'Hoje · 21h · State Farm Arena', competition:'NBA · Temporada Regular', title:'Atlanta × Golden State', bettvPick:'Atlanta', bettvConf:76, bettvConf:76, bettvReason:'Hawks 80.5% SportRadar. Warriors sem Curry lesionado.', home:{name:'Atlanta', logo:null, sub:'Conf. Leste', pct:78}, away:{name:'Golden State', logo:'warriors', sub:'Conf. Oeste', pct:19}, draw:3 },
    { id:'b7', status:'upcoming', startTime:'2026-03-22T00:30:00Z', statusLabel:'Hoje · 21h30 · American Airlines', competition:'NBA · Temporada Regular', title:'Dallas × LA Clippers', bettvPick:'LA Clippers', bettvConf:68, bettvReason:'Clippers 72.7% SportRadar. Dallas em reconstrução.', home:{name:'Dallas', logo:null, sub:'Conf. Oeste', pct:27}, away:{name:'LA Clippers', logo:null, sub:'Conf. Oeste', pct:69}, draw:4 },
    { id:'b8', status:'upcoming', startTime:'2026-03-22T01:30:00Z', statusLabel:'Hoje · 22h30 · Delta Center', competition:'NBA · Temporada Regular', title:'Utah × Philadelphia', bettvPick:'Philadelphia', bettvConf:63, bettvReason:'76ers 67% SportRadar. Embiid voltou da lesão.', home:{name:'Utah', logo:null, sub:'Conf. Oeste', pct:33}, away:{name:'Philadelphia', logo:null, sub:'Conf. Leste', pct:63}, draw:4 },
    { id:'b9', status:'upcoming', startTime:'2026-03-22T02:00:00Z', statusLabel:'Hoje · 23h · Footprint Center', competition:'NBA · Temporada Regular', title:'Phoenix × Milwaukee', bettvPick:'Phoenix', bettvConf:79, bettvReason:'Suns 83.2% SportRadar. Bucks 16.8% — em crise total.', home:{name:'Phoenix', logo:'suns', sub:'Conf. Oeste', pct:80}, away:{name:'Milwaukee', logo:null, sub:'Conf. Leste', pct:17}, draw:3 },
    // ── NBA amanhã 22/03 ──
    { id:'b10', status:'upcoming', startTime:'2026-03-22T21:00:00Z', statusLabel:'Amanhã · 18h · Ball Arena', competition:'NBA · Temporada Regular', title:'Denver × Portland', bettvPick:'Denver', bettvConf:72, bettvReason:'Nuggets favoritos em casa. Jokic dominante. Portland rebuilding.', home:{name:'Denver', logo:'nuggets', sub:'Conf. Oeste', pct:73}, away:{name:'Portland', logo:null, sub:'Conf. Oeste', pct:19}, draw:8 },
  ]},
  volei: { label:'Vôlei', items:[
    // ── Liga das Nações de Vôlei — começa maio 2026 ──
    { id:'v1', status:'upcoming', startTime:'2026-05-20T19:00:00-03:00', statusLabel:'20/05 · 19h · Rio de Janeiro', competition:'VNL Masculino 2026 · Semana 1', title:'Brasil × França', bettvPick:'Brasil', bettvConf:65, bettvReason:'Brasil Nº2 mundial em casa no Rio. França Nº4. Leal e Flávio superiores.', home:{name:'Brasil', logo:null, sub:'Nº2 Mundial', pct:64}, away:{name:'França', logo:null, sub:'Nº4 Mundial', pct:24}, draw:12 },
    { id:'v2', status:'upcoming', startTime:'2026-05-22T19:00:00-03:00', statusLabel:'22/05 · 19h · Rio de Janeiro', competition:'VNL Masculino 2026 · Semana 1', title:'Brasil × Polônia', bettvPick:'Empate/Equilibrado', bettvConf:42, bettvReason:'Brasil e Polônia H2H 50/50. León vs Kurek — equilíbrio técnico.', home:{name:'Brasil', logo:null, sub:'Nº2 Mundial', pct:45}, away:{name:'Polônia', logo:null, sub:'Nº3 Mundial', pct:44}, draw:11 },
    // ── Superliga 2025/26 — Final prevista ──
    { id:'v3', status:'upcoming', startTime:'2026-04-12T17:00:00-03:00', statusLabel:'12/04 · 17h · Local a definir', competition:'Superliga Masc. 2025/26 · Semifinal', title:'Sada Cruzeiro × Minas', bettvPick:'Sada Cruzeiro', bettvConf:63, bettvReason:'Sada Cruzeiro favorito. Melhor elenco e desempenho na temporada.', home:{name:'Sada Cruzeiro', logo:null, sub:'1º Superliga', pct:62}, away:{name:'Minas', logo:null, sub:'2º Superliga', pct:27}, draw:11 },
    { id:'v4', status:'upcoming', startTime:'2026-04-19T17:00:00-03:00', statusLabel:'19/04 · 17h · Local a definir', competition:'Superliga Fem. 2025/26 · Final', title:'Sesc Flamengo × Praia Clube', bettvPick:'Sesc Flamengo', bettvConf:57, bettvReason:'Sesc favorita. Praia especialista em playoffs — H2H equilibrado.', home:{name:'Sesc Flamengo', logo:null, sub:'1º Superliga Fem.', pct:55}, away:{name:'Praia Clube', logo:null, sub:'2º Superliga Fem.', pct:30}, draw:15 },
  ]},
  mma: { label:'MMA / UFC', items:[
    // ── UFC Fight Night 271 — próximo evento confirmado ──
    { id:'m1', status:'upcoming', startTime:'2026-03-28T22:00:00-05:00', statusLabel:'28/03 · Las Vegas · UFC FN 271', competition:'UFC Fight Night 271', title:'Du Plessis × Whittaker II', bettvPick:'Du Plessis', bettvConf:56, bettvReason:'Du Plessis nocauteou Whittaker no 1º duelo. Controlou grappling. Favoritado.', home:{name:'D. Du Plessis', logo:null, sub:'Camp. Médio', pct:54}, away:{name:'R. Whittaker', logo:null, sub:'Ex-campeão', pct:36}, draw:10 },
    { id:'m2', status:'upcoming', startTime:'2026-03-28T20:00:00-05:00', statusLabel:'28/03 · Las Vegas · UFC FN 271', competition:'UFC Fight Night 271 · Co-main', title:'Adesanya × Pyfer', bettvPick:'Adesanya', bettvConf:58, bettvReason:'Adesanya ex-campeão busca retorno ao top 5. Pyfer resiliente mas carece de elite.', home:{name:'I. Adesanya', logo:null, sub:'Ex-camp. MW · 25-4', pct:55}, away:{name:'J. Pyfer', logo:null, sub:'Top 15 MW · 13-2', pct:34}, draw:11 },
    // ── UFC 315 — Abril ──
    { id:'m3', status:'upcoming', startTime:'2026-04-12T22:00:00-05:00', statusLabel:'12/04 · Las Vegas · UFC 315', competition:'UFC 315', title:'Poirier × Holloway III', bettvPick:'Holloway', bettvConf:52, bettvReason:'Holloway H2H 2-0 vs Poirier. Mais consistente no striking.', home:{name:'D. Poirier', logo:null, sub:'Ex-camp. Leve', pct:36}, away:{name:'M. Holloway', logo:null, sub:'Camp. Pena', pct:52}, draw:12 },
    // ── UFC 316 — Abu Dhabi ──
    { id:'m4', status:'upcoming', startTime:'2026-04-26T20:00:00+04:00', statusLabel:'26/04 · Abu Dhabi · UFC 316', competition:'UFC 316', title:'Makhachev × Oliveira II', bettvPick:'Makhachev', bettvConf:64, bettvReason:'Makhachev dominou 1º duelo. Islam mais completo no grappling Dagestani.', home:{name:'I. Makhachev', logo:null, sub:'Camp. Leve', pct:62}, away:{name:'C. Oliveira', logo:null, sub:'Do Bronx · Top 3', pct:29}, draw:9 },
    // ── UFC Fight Night 272 — São Paulo (BRASIL) ──
    { id:'m5', status:'upcoming', startTime:'2026-05-10T20:00:00-03:00', statusLabel:'10/05 · São Paulo · UFC FN 272', competition:'UFC Fight Night 272', title:'Pantoja × Royval II', bettvPick:'Pantoja', bettvConf:67, bettvReason:'Pantoja campeão. Venceu Royval em 2023. Luta em casa no Brasil.', home:{name:'A. Pantoja', logo:null, sub:'Camp. Mosca', pct:66}, away:{name:'B. Royval', logo:null, sub:'Top 5 Mosca', pct:23}, draw:11 },
    // ── UFC 317 — Maio ──
    { id:'m6', status:'upcoming', startTime:'2026-05-24T22:00:00-05:00', statusLabel:'24/05 · Las Vegas · UFC 317', competition:'UFC 317', title:'Pereira × Prochazka III', bettvPick:'Pereira', bettvConf:55, bettvReason:'Poatan venceu os 2 duelos anteriores. Prochazka é imprevisível mas Pereira favorito.', home:{name:'A. Pereira', logo:null, sub:'Camp. LHW', pct:53}, away:{name:'J. Prochazka', logo:null, sub:'2x Vice-Camp.', pct:38}, draw:9 },
  ]},
  tenis: { label:'Tênis', items:[
    // ── Miami Open — HOJE ao vivo 21/03 ──
    { id:'t1', status:'live', startTime:'2026-03-21T18:00:00-05:00', statusLabel:'AO VIVO · Miami Open · QF', competition:'ATP Miami Open 2026 · Quartas', title:'Sinner × Tsitsipas', bettvPick:'Sinner', bettvConf:74, bettvReason:'Sinner venceu IW sem perder set. Tsitsipas surpreendeu mas Jannik é superior.', home:{name:'J. Sinner', logo:'sinner', sub:'Nº2 · IW Campeão', pct:73}, away:{name:'S. Tsitsipas', logo:'tsitsipas', sub:'Nº7 ATP', pct:19}, draw:8 },
    { id:'t2', status:'live', startTime:'2026-03-21T20:00:00-05:00', statusLabel:'AO VIVO · Miami Open · QF', competition:'ATP Miami Open 2026 · Quartas', title:'Alcaraz × Fritz', bettvPick:'Alcaraz', bettvConf:66, bettvReason:'Alcaraz venceu AO 2026. Chegou sem drop sets. Fritz resiliente mas outsider.', home:{name:'C. Alcaraz', logo:'alcaraz', sub:'Nº1 ATP', pct:65}, away:{name:'T. Fritz', logo:'fritz', sub:'Nº5 ATP', pct:22}, draw:13 },
    { id:'t3', status:'live', startTime:'2026-03-21T16:00:00-05:00', statusLabel:'AO VIVO · Miami Open · WTA QF', competition:'WTA Miami Open 2026 · Quartas', title:'Sabalenka × Rybakina', bettvPick:'Sabalenka', bettvConf:60, bettvReason:'Sabalenka Nº1 WTA. Campeã Miami 2025. H2H favorável vs Rybakina.', home:{name:'A. Sabalenka', logo:'sabalenka', sub:'Nº1 WTA', pct:59}, away:{name:'E. Rybakina', logo:null, sub:'Nº4 WTA', pct:29}, draw:12 },
    // ── Miami Open SF e Final ──
    { id:'t4', status:'upcoming', startTime:'2026-03-26T14:00:00-05:00', statusLabel:'26/03 · 15h · Miami Open · WTA SF', competition:'WTA Miami Open 2026 · Semifinal', title:'Sabalenka × Gauff', bettvPick:'Sabalenka', bettvConf:58, bettvReason:'Sabalenka Nº1. Gauff Nº3 forte em Miami mas H2H desfavorável (2V-5D).', home:{name:'A. Sabalenka', logo:'sabalenka', sub:'Nº1 WTA', pct:57}, away:{name:'C. Gauff', logo:'gauff', sub:'Nº3 WTA', pct:32}, draw:11 },
    { id:'t5', status:'upcoming', startTime:'2026-03-27T14:00:00-05:00', statusLabel:'27/03 · 15h · Miami Open · ATP SF', competition:'ATP Miami Open 2026 · Semifinal', title:'Sinner × Alcaraz', bettvPick:'Sinner', bettvConf:47, bettvReason:'H2H histórico 6-6. Sinner 2 finais em Miami. Alcaraz venceu IW. Equilíbrio total.', home:{name:'J. Sinner', logo:'sinner', sub:'Nº2 ATP', pct:44}, away:{name:'C. Alcaraz', logo:'alcaraz', sub:'Nº1 ATP', pct:38}, draw:18 },
    { id:'t6', status:'upcoming', startTime:'2026-03-29T14:00:00-05:00', statusLabel:'29/03 · 15h · Miami Open · Final', competition:'ATP Miami Open 2026 · Final', title:'Final Miami Open 2026', bettvPick:'Alcaraz', bettvConf:43, bettvReason:'Alcaraz 2 títulos em 2026 (AO+IW). Sinner pode vencer mas pressão de Nº2 maior.', home:{name:'C. Alcaraz', logo:'alcaraz', sub:'Nº1 ATP', pct:48}, away:{name:'J. Sinner', logo:'sinner', sub:'Nº2 ATP', pct:38}, draw:14 },
    // ── Roland Garros ──
    { id:'t7', status:'upcoming', startTime:'2026-05-25T10:00:00+02:00', statusLabel:'25/05 · Paris · Roland Garros', competition:'Roland Garros 2026', title:'Roland Garros 2026', bettvPick:'Alcaraz', bettvConf:41, bettvReason:'Alcaraz bicampeão em Paris. Saibro é sua superfície. Sinner e Zverev ameaças.', home:{name:'C. Alcaraz', logo:'alcaraz', sub:'Bicampeão RG', pct:38}, away:{name:'J. Sinner', logo:'sinner', sub:'Finalista 2025', pct:22}, draw:40 },
  ]},
  esports: { label:'E-sports', items:[
    // ── CBLOL 2026 Etapa 1 — começa 28/03 (confirmado pela Riot) ──
    { id:'e1', status:'upcoming', startTime:'2026-03-28T13:00:00-03:00', statusLabel:'28/03 · Riot Arena SP · 13h', competition:'CBLOL 2026 · Etapa 1 · Rd 1', title:'LOUD × paiN Gaming', bettvPick:'LOUD', bettvConf:66, bettvReason:'LOUD campeã Copa CBLOL 2026. Bull e RedBert dominantes. paiN sem título desde 2023.', home:{name:'LOUD', logo:'loud', sub:'Campeã Copa 2026', pct:62}, away:{name:'paiN Gaming', logo:null, sub:'4º Copa', pct:24}, draw:14 },
    { id:'e2', status:'upcoming', startTime:'2026-03-28T15:00:00-03:00', statusLabel:'28/03 · Riot Arena SP · 15h', competition:'CBLOL 2026 · Etapa 1 · Rd 1', title:'FURIA × RED Canids', bettvPick:'FURIA', bettvConf:54, bettvReason:'FURIA bootcampou Coreia. RED Canids inconstante mas Grevthar diferencial.', home:{name:'FURIA', logo:'furia', sub:'Americas Cup', pct:52}, away:{name:'RED Canids', logo:null, sub:'5º Copa', pct:32}, draw:16 },
    { id:'e3', status:'upcoming', startTime:'2026-04-04T13:00:00-03:00', statusLabel:'04/04 · Riot Arena SP · 13h', competition:'CBLOL 2026 · Etapa 1 · Rd 2', title:'LOUD × FURIA', bettvPick:'LOUD', bettvConf:55, bettvReason:'LOUD lidera H2H histórico vs FURIA (12V-8D). FURIA motivada pós-bootcamp Korea.', home:{name:'LOUD', logo:'loud', sub:'Campeã Copa', pct:53}, away:{name:'FURIA', logo:'furia', sub:'Americas Cup', pct:35}, draw:12 },
    // ── LCK Playoffs Coreia — Abril ──
    { id:'e4', status:'upcoming', startTime:'2026-04-05T17:00:00+09:00', statusLabel:'05/04 · 05h · LCK Arena · Seoul', competition:'LCK Spring 2026 · Playoffs', title:'T1 × Gen.G', bettvPick:'T1', bettvConf:58, bettvReason:'T1 e Faker históricos nos playoffs LCK. Gen.G com Chovy mas T1 tem experiência.', home:{name:'T1', logo:'t1', sub:'1º LCK', pct:56}, away:{name:'Gen.G', logo:null, sub:'2º LCK', pct:32}, draw:12 },
    // ── CS2 Major 2026 ──
    { id:'e5', status:'upcoming', startTime:'2026-05-01T14:00:00+02:00', statusLabel:'01/05 · CS2 Major 2026', competition:'CS2 Major 2026 · Quartas', title:'NaVi × FaZe Clan', bettvPick:'NaVi', bettvConf:53, bettvReason:'NaVi com s1mple retornado. FaZe forte mas NaVi tem mais títulos em Majors (3).', home:{name:'Natus Vincere', logo:null, sub:'Top 5 CS2', pct:52}, away:{name:'FaZe Clan', logo:null, sub:'Top 5 CS2', pct:35}, draw:13 },
  ]},
}
