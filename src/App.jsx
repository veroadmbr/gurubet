...
const ESPORTES = {
  futebol: { label:'Futebol', items:[
    // ── Premier League 22/03 (amanhã) ──
    { id:'f-new-sun', startTime:'2026-03-22T12:00:00Z', statusLabel:'Amanhã · 09h BRT · St James Park',  competition:'Premier League · Rodada 31', title:'Newcastle United × Sunderland AFC',  bettvPick:'Newcastle United', bettvConf:57, bettvReason:'Newcastle 5º (55pts) 57.1% SportRadar. Sunderland promovido 19º 18.8%. Vantagem em casa clara.', home:{name:'Newcastle United',    logo:'newcastle', sub:'5º · 55pts · 57.1%',pct:57}, away:{name:'Sunderland AFC',      logo:'sunderland',sub:'19º · 19pts · 18.8%',pct:19}, draw:24 },
    { id:'f-avl-whu', startTime:'2026-03-22T14:15:00Z', statusLabel:'Amanhã · 11h15 BRT · Villa Park',   competition:'Premier League · Rodada 31', title:'Aston Villa × West Ham United',      bettvPick:'Aston Villa',      bettvConf:52, bettvReason:'Villa 7º (48pts) 51.5% SportRadar. West Ham 15º (28pts) 23.3%. Watkins artilheiro.', home:{name:'Aston Villa',          logo:'astonvilla',sub:'7º · 48pts · 51.5%',pct:52}, away:{name:'West Ham United',      logo:'westham',   sub:'15º · 28pts · 23.3%',pct:23}, draw:25 },
    { id:'f-tot-nfo', startTime:'2026-03-22T14:15:00Z', statusLabel:'Amanhã · 11h15 BRT · T.Hotspur Std',competition:'Premier League · Rodada 31', title:'Tottenham Hotspur × Nottingham Forest',bettvPick:'Nottingham Forest', bettvConf:41, bettvReason:'Forest 11º (40pts) 30.7% mas sólido fora. Tottenham 8º (46pts) 41.2%. Equilíbrio.', home:{name:'Tottenham Hotspur',    logo:'tottenham', sub:'8º · 46pts · 41.2%',pct:41}, away:{name:'Nottingham Forest',   logo:'nottmforest',sub:'11º · 40pts · 30.7%',pct:31}, draw:28 },
    // ── La Liga 22/03 ──
    { id:'f-bar-rvc', startTime:'2026-03-22T13:00:00Z', statusLabel:'Amanhã · 10h BRT · Camp Nou',       competition:'La Liga · Rodada 29',        title:'FC Barcelona × Rayo Vallecano',     bettvPick:'FC Barcelona',     bettvConf:78, bettvReason:'Barcelona lidera La Liga com 70pts e 78% SportRadar. Rayo Vallecano 8.8%.', home:{name:'FC Barcelona',         logo:'barcelona', sub:'1º · 70pts · 78%',  pct:78}, away:{name:'Rayo Vallecano',       logo:null,        sub:'9º · 34pts · 8.8%', pct:9},  draw:13 },
    { id:'f-rma-atm', startTime:'2026-03-22T20:00:00Z', statusLabel:'Amanhã · 17h BRT · Bernabéu',       competition:'La Liga · Rodada 29',        title:'Real Madrid × Atletico Madrid',     bettvPick:'Real Madrid',      bettvConf:51, bettvReason:'Real Madrid 2º (68pts) 51.3% SportRadar. Derby Madrileno equilibrado. Atletico 24.7%.', home:{name:'Real Madrid',           logo:'realmadrid',sub:'2º · 68pts · 51.3%',pct:51}, away:{name:'Atletico Madrid',      logo:'atletimadrid',sub:'3º · 62pts · 24.7%',pct:25}, draw:24 },
    // ── La Liga 04/04 ──
    { id:'f-atm-bar', startTime:'2026-04-04T19:00:00Z', statusLabel:'04/04 · 16h BRT · Metropolitano',   competition:'La Liga · Rodada 30',        title:'Atletico Madrid × FC Barcelona',    bettvPick:'FC Barcelona',     bettvConf:41, bettvReason:'Barcelona 40.8% SportRadar. Atletico em casa 34.6%. Barça lidera tabela mas Metropolitano difícil.', home:{name:'Atletico Madrid',      logo:'atletimadrid',sub:'3º · 62pts · 34.6%',pct:35}, away:{name:'FC Barcelona',         logo:'barcelona', sub:'1º · 70pts · 40.8%',pct:41}, draw:24 },
    { id:'f-mal-rma', startTime:'2026-04-04T14:15:00Z', statusLabel:'04/04 · 11h15 BRT · Visit Mallorca', competition:'La Liga · Rodada 30',       title:'RCD Mallorca × Real Madrid',        bettvPick:'Real Madrid',      bettvConf:60, bettvReason:'Real Madrid 60.3% SportRadar. Mallorca 17.5% em casa. Mbappé em sequência de gols.', home:{name:'RCD Mallorca',          logo:null,        sub:'7º · 38pts · 17.5%',pct:18}, away:{name:'Real Madrid',           logo:'realmadrid',sub:'2º · 68pts · 60.3%',pct:60}, draw:22 },
    // ── Champions League QF 1ª Mão 07-08/04 ──
    { id:'f-ucl-rmabmu', startTime:'2026-04-07T19:00:00Z', statusLabel:'07/04 · 16h BRT · Bernabéu',     competition:'Champions League · QF 1ª Mão', title:'Real Madrid × Bayern Munich',      bettvPick:'Bayern Munich',    bettvConf:45, bettvReason:'Bayern Munich 44.5% SportRadar favorito. Real 31%. Impressionante: Bayern venceu 1-2 na fase de grupos.', home:{name:'Real Madrid',           logo:'realmadrid',sub:'QF · ESP · 31%',    pct:31}, away:{name:'Bayern Munich',        logo:'bayernmunich',sub:'QF · ALE · 44.5%',pct:45}, draw:24 },
    { id:'f-ucl-spoars', startTime:'2026-04-07T19:00:00Z', statusLabel:'07/04 · 16h BRT · Estádio de Alvalade', competition:'Champions League · QF 1ª Mão', title:'Sporting CP × Arsenal FC',    bettvPick:'Arsenal FC',       bettvConf:54, bettvReason:'Arsenal FC 53.7% SportRadar. Venceu Leverkusen 2-0 nas oitavas. Sporting em casa 21.3%.', home:{name:'Sporting CP',           logo:null,        sub:'QF · POR · 21.3%', pct:21}, away:{name:'Arsenal FC',            logo:'arsenal',   sub:'QF · ING · 53.7%', pct:54}, draw:25 },
    { id:'f-ucl-psglfc', startTime:'2026-04-08T19:00:00Z', statusLabel:'08/04 · 16h BRT · Parc des Princes', competition:'Champions League · QF 1ª Mão', title:'PSG × Liverpool FC',          bettvPick:'PSG',              bettvConf:50, bettvReason:'PSG 49.6% SportRadar em casa. Venceu Chelsea 5-2 e 3-0 nas oitavas. Liverpool 26.3%.', home:{name:'Paris Saint-Germain',   logo:'psg',       sub:'QF · FRA · 49.6%', pct:50}, away:{name:'Liverpool FC',          logo:'liverpool', sub:'QF · ING · 26.3%', pct:26}, draw:24 },
    { id:'f-ucl-baratm', startTime:'2026-04-08T19:00:00Z', statusLabel:'08/04 · 16h BRT · Camp Nou',     competition:'Champions League · QF 1ª Mão', title:'FC Barcelona × Atletico Madrid',  bettvPick:'FC Barcelona',     bettvConf:61, bettvReason:'Barcelona 61.1% SportRadar. Goleou Newcastle 7-2. Atletico em dificuldade 18.5%.', home:{name:'FC Barcelona',         logo:'barcelona', sub:'QF · ESP · 61.1%', pct:61}, away:{name:'Atletico Madrid',      logo:'atletimadrid',sub:'QF · ESP · 18.5%',pct:19}, draw:20 },
    // ── Premier League 11-12/04 ──
    { id:'f-ars-bou', startTime:'2026-04-11T11:30:00Z', statusLabel:'11/04 · 08h30 BRT · Emirates',      competition:'Premier League · Rodada 32', title:'Arsenal FC × Bournemouth',          bettvPick:'Arsenal FC',       bettvConf:71, bettvReason:'Arsenal lidera PL. 70.8% SportRadar. Bournemouth 11.5%.', home:{name:'Arsenal FC',            logo:'arsenal',   sub:'1º · 70pts · 70.8%',pct:71}, away:{name:'AFC Bournemouth',       logo:null,        sub:'12º · 33pts · 11.5%',pct:12}, draw:17 },
    { id:'f-lfc-ful', startTime:'2026-04-11T16:30:00Z', statusLabel:'11/04 · 13h30 BRT · Anfield',       competition:'Premier League · Rodada 32', title:'Liverpool FC × Fulham FC',          bettvPick:'Liverpool FC',     bettvConf:63, bettvReason:'Liverpool 3º (66pts) 63.3% SportRadar. Fulham 8º (43pts) 16.8%.', home:{name:'Liverpool FC',          logo:'liverpool', sub:'3º · 66pts · 63.3%',pct:63}, away:{name:'Fulham FC',             logo:null,        sub:'8º · 43pts · 16.8%',pct:17}, draw:20 },
    // ── UCL QF 2ª Mão 14-15/04 ──
    { id:'f-ucl-lfcpsg', startTime:'2026-04-14T19:00:00Z', statusLabel:'14/04 · 16h BRT · Anfield',       competition:'Champions League · QF 2ª Mão', title:'Liverpool FC × PSG',             bettvPick:'PSG',              bettvConf:53, bettvReason:'PSG 52.5% SportRadar favorito após domínio nas oitavas. Liverpool 24.5% precisando virar.', home:{name:'Liverpool FC',          logo:'liverpool', sub:'QF · ING · 24.5%', pct:25}, away:{name:'Paris Saint-Germain',   logo:'psg',       sub:'QF · FRA · 52.5%', pct:53}, draw:22 },
    { id:'f-ucl-atmbar', startTime:'2026-04-14T19:00:00Z', statusLabel:'14/04 · 16h BRT · Metropolitano', competition:'Champions League · QF 2ª Mão', title:'Atletico Madrid × FC Barcelona',  bettvPick:'FC Barcelona',     bettvConf:61, bettvReason:'Barcelona 61.2% SportRadar. Atletico 19.2%. Barça domina o confronto.', home:{name:'Atletico Madrid',      logo:'atletimadrid',sub:'QF · ESP · 19.2%',pct:19}, away:{name:'FC Barcelona',         logo:'barcelona', sub:'QF · ESP · 61.2%', pct:61}, draw:20 },
    { id:'f-ucl-bmurma', startTime:'2026-04-15T19:00:00Z', statusLabel:'15/04 · 16h BRT · Allianz Arena',  competition:'Champions League · QF 2ª Mão', title:'Bayern Munich × Real Madrid',     bettvPick:'Bayern Munich',    bettvConf:50, bettvReason:'2º jogo após 1-2 em Madri. Bayern em casa 50/50. Real precisa defender vantagem.', home:{name:'Bayern Munich',        logo:'bayernmunich',sub:'QF · ALE',         pct:45}, away:{name:'Real Madrid',           logo:'realmadrid',sub:'QF · ESP',          pct:35}, draw:20 },
    { id:'f-ucl-arsspo', startTime:'2026-04-15T19:00:00Z', statusLabel:'15/04 · 16h BRT · Emirates',       competition:'Champions League · QF 2ª Mão', title:'Arsenal FC × Sporting CP',       bettvPick:'Arsenal FC',       bettvConf:65, bettvReason:'Arsenal favorito para avançar. Vantagem consolidada. Sporting precisa de milagre.', home:{name:'Arsenal FC',            logo:'arsenal',   sub:'QF · ING',         pct:65}, away:{name:'Sporting CP',           logo:null,        sub:'QF · POR',          pct:20}, draw:15 },
  ]},
  basquete: { label:'Basquete', items:[
    // ── NBA AO VIVO — WAS×OKC (inprogress Q2, OKC 68-63) ──
    { id:'b-wokc', startTime:'2026-03-21T21:00:00Z', statusLabel:'AO VIVO · Q2 · Capital One Arena',   competition:'NBA · Temporada Regular',  title:'Washington Wizards × OKC Thunder',   bettvPick:'OKC Thunder',          bettvConf:94, bettvReason:'OKC 95.8% SportRadar. Lidera Q2 68-63. Shai dominante.', home:{name:'Washington Wizards',   logo:'wizards',       sub:'Último Leste · 4.2%',pct:4},  away:{name:'OKC Thunder',          logo:'okc',           sub:'1º Oeste · 95.8%',   pct:94}, draw:2 },
    // ── NBA Hoje noite (21/03 BRT) ──
    { id:'b-olal', startTime:'2026-03-21T23:00:00Z', statusLabel:'Hoje · 20h BRT · Kaseya Center',     competition:'NBA · Temporada Regular',  title:'Orlando Magic × LA Lakers',          bettvPick:'LA Lakers',            bettvConf:57, bettvReason:'Lakers 60.8% SportRadar. LeBron+AD dominam. Orlando perdeu 5 dos últimos 7.', home:{name:'Orlando Magic',        logo:'magic',         sub:'8º Leste · 39.2%',   pct:39}, away:{name:'LA Lakers',            logo:'lakers',        sub:'Conf. Oeste · 60.8%',pct:58}, draw:3 },
    { id:'b-cmem', startTime:'2026-03-21T23:00:00Z', statusLabel:'Hoje · 20h BRT · Spectrum Center',   competition:'NBA · Temporada Regular',  title:'Charlotte Hornets × Memphis Grizzlies',bettvPick:'Charlotte Hornets',  bettvConf:89, bettvReason:'Charlotte 93% SportRadar. Memphis em colapso — pior fase da temporada.', home:{name:'Charlotte Hornets',    logo:'hornets',       sub:'Conf. Leste · 93%',  pct:89}, away:{name:'Memphis Grizzlies',    logo:'grizzlies',     sub:'Conf. Oeste · 7%',   pct:7},  draw:4 },
    { id:'b-ncle', startTime:'2026-03-21T23:00:00Z', statusLabel:'Hoje · 20h BRT · Smoothie King',     competition:'NBA · Temporada Regular',  title:'New Orleans Pelicans × Cleveland Cavaliers',bettvPick:'Cleveland Cavaliers',bettvConf:63,bettvReason:'Cleveland 67.1% SportRadar. Em 4V seguidas. Donovan Mitchell no melhor momento.', home:{name:'New Orleans Pelicans',  logo:'pelicans',      sub:'Conf. Leste · 32.9%',pct:33}, away:{name:'Cleveland Cavaliers',  logo:'cavaliers',     sub:'3º Leste · 67.1%',   pct:63}, draw:4 },
    { id:'b-hmia', startTime:'2026-03-22T00:00:00Z', statusLabel:'Hoje · 21h BRT · Toyota Center',     competition:'NBA · Temporada Regular',  title:'Houston Rockets × Miami Heat',       bettvPick:'Houston Rockets',      bettvConf:51, bettvReason:'Houston 54.7% SportRadar. 5V seguidas em casa. Miami sem Tyler Herro.', home:{name:'Houston Rockets',      logo:'rockets',       sub:'Conf. Oeste · 54.7%',pct:52}, away:{name:'Miami Heat',            logo:'heat',          sub:'Conf. Leste · 45.3%',pct:43}, draw:5 },
    { id:'b-sind', startTime:'2026-03-22T00:00:00Z', statusLabel:'Hoje · 21h BRT · AT&T Center',       competition:'NBA · Temporada Regular',  title:'San Antonio Spurs × Indiana Pacers', bettvPick:'San Antonio Spurs',    bettvConf:89, bettvReason:'Spurs 93.4% SportRadar. Wembanyama 24pts/12reb por jogo. Pacers sem Haliburton.', home:{name:'San Antonio Spurs',    logo:'spurs',         sub:'Conf. Oeste · 93.4%',pct:89}, away:{name:'Indiana Pacers',        logo:'pacers',        sub:'Conf. Leste · 6.6%', pct:7},  draw:4 },
    { id:'b-agws', startTime:'2026-03-22T00:00:00Z', statusLabel:'Hoje · 21h BRT · State Farm Arena',   competition:'NBA · Temporada Regular',  title:'Atlanta Hawks × Golden State Warriors',bettvPick:'Atlanta Hawks',      bettvConf:75, bettvReason:'Hawks 78.3% SportRadar. Warriors sem Curry — em reconstrução total.', home:{name:'Atlanta Hawks',         logo:'hawks',         sub:'Conf. Leste · 78.3%',pct:76}, away:{name:'Golden State Warriors', logo:'warriors',      sub:'Conf. Oeste · 21.7%',pct:21}, draw:3 },
    { id:'b-dlac', startTime:'2026-03-22T00:30:00Z', statusLabel:'Hoje · 21h30 BRT · Am. Airlines Ctr', competition:'NBA · Temporada Regular',  title:'Dallas Mavericks × LA Clippers',     bettvPick:'LA Clippers',          bettvConf:68, bettvReason:'Clippers 71.7% SportRadar. Dallas rebuilding — sem Luka após troca.', home:{name:'Dallas Mavericks',     logo:'mavericks',     sub:'Conf. Oeste · 28.3%',pct:28}, away:{name:'LA Clippers',           logo:'clippers',      sub:'Conf. Oeste · 71.7%',pct:68}, draw:4 },
    { id:'b-uphi', startTime:'2026-03-22T01:30:00Z', statusLabel:'Hoje · 22h30 BRT · Delta Center',     competition:'NBA · Temporada Regular',  title:'Utah Jazz × Philadelphia 76ers',     bettvPick:'Philadelphia 76ers',   bettvConf:62, bettvReason:'76ers 66.3% SportRadar. Embiid voltou de lesão e está dominante.', home:{name:'Utah Jazz',             logo:'jazz',          sub:'Conf. Oeste · 33.7%',pct:34}, away:{name:'Philadelphia 76ers',   logo:'sixers',        sub:'Conf. Leste · 66.3%',pct:62}, draw:4 },
    { id:'b-pmil', startTime:'2026-03-22T02:00:00Z', statusLabel:'Hoje · 23h BRT · Footprint Center',   competition:'NBA · Temporada Regular',  title:'Phoenix Suns × Milwaukee Bucks',     bettvPick:'Phoenix Suns',         bettvConf:79, bettvReason:'Suns 83.1% SportRadar. Bucks sem Giannis — temporada praticamente encerrada.', home:{name:'Phoenix Suns',          logo:'suns',          sub:'Conf. Oeste · 83.1%',pct:80}, away:{name:'Milwaukee Bucks',       logo:'bucks',         sub:'Conf. Leste · 16.9%',pct:17}, draw:3 },
    // ── NBA 22/03 (amanhã) ──
    { id:'b-dpor', startTime:'2026-03-22T21:00:00Z', statusLabel:'Amanhã · 18h BRT · Ball Arena',       competition:'NBA · Temporada Regular',  title:'Denver Nuggets × Portland Trail Blazers',bettvPick:'Denver Nuggets',   bettvConf:72, bettvReason:'Nuggets favoritos em casa. Jokic triplo-duplo machine. Portland em reconstrução.', home:{name:'Denver Nuggets',       logo:'nuggets',       sub:'Conf. Oeste',         pct:73}, away:{name:'Portland Trail Blazers',logo:'blazers',       sub:'Conf. Oeste',         pct:19}, draw:8 },
    { id:'b-bmin', startTime:'2026-03-23T00:00:00Z', statusLabel:'Dom · 21h BRT · TD Garden',           competition:'NBA · Temporada Regular',  title:'Boston Celtics × Minnesota Timberwolves',bettvPick:'Boston Celtics', bettvConf:58, bettvReason:'Celtics 1º do Leste em casa. Timberwolves fortes mas viajando 4.000 milhas.', home:{name:'Boston Celtics',        logo:'celtics',       sub:'1º Leste',            pct:58}, away:{name:'Minnesota Timberwolves',logo:'timberwolves',  sub:'Conf. Oeste',         pct:35}, draw:7 },
    { id:'b-pokc', startTime:'2026-03-23T23:00:00Z', statusLabel:'Seg · 20h BRT · Wells Fargo Center',  competition:'NBA · Temporada Regular',  title:'Philadelphia 76ers × OKC Thunder',   bettvPick:'OKC Thunder',          bettvConf:55, bettvReason:'OKC favorito mesmo fora. SGA vs Embiid — duelo épico dos MVPs.', home:{name:'Philadelphia 76ers',   logo:'sixers',        sub:'Conf. Leste',         pct:45}, away:{name:'OKC Thunder',          logo:'okc',           sub:'1º Oeste',            pct:52}, draw:3 },
  ]},
  volei: { label:'Vôlei', items:[
    { id:'v-scm',  startTime:'2026-03-28T19:00:00-03:00', statusLabel:'28/03 · 19h BRT · Uberlândia',    competition:'Superliga Masc. 2025/26 · Semifinal J.1',  title:'Sada Cruzeiro × Minas',          bettvPick:'Sada Cruzeiro',bettvConf:61, bettvReason:'Sada 1º lugar — melhor campanha da fase. Minas 2º forte mas Sada tem vantagem histórica.', home:{name:'Sada Cruzeiro',logo:null,sub:'1º Superliga',pct:60},away:{name:'Minas',       logo:null,sub:'2º Superliga',pct:29},draw:11},
    { id:'v-sff',  startTime:'2026-03-28T21:00:00-03:00', statusLabel:'28/03 · 21h BRT · São Paulo',      competition:'Superliga Fem. 2025/26 · Semifinal J.1',   title:'Sesc Flamengo × Praia Clube',    bettvPick:'Sesc Flamengo',bettvConf:57, bettvReason:'Sesc 1ª colocada. Praia especialista em playoffs mas Sesc mais regular na temporada.', home:{name:'Sesc Flamengo',logo:null,sub:'1ª Fem.',    pct:55},away:{name:'Praia Clube', logo:null,sub:'3ª Fem.',    pct:30},draw:15},
    { id:'v-vnl1', startTime:'2026-05-20T19:00:00-03:00', statusLabel:'20/05 · 19h · Rio de Janeiro',     competition:'VNL Masculino 2026 · Semana 1',            title:'Brasil × França',                bettvPick:'Brasil',       bettvConf:65, bettvReason:'Brasil Nº2 mundial em casa no Rio. França Nº4. Leal e Flávio superiores.', home:{name:'Brasil',      logo:null,sub:'Nº2 Mundial', pct:64},away:{name:'França',   logo:null,sub:'Nº4 Mundial', pct:24},draw:12},
    { id:'v-vnl2', startTime:'2026-05-22T19:00:00-03:00', statusLabel:'22/05 · 19h · Rio de Janeiro',     competition:'VNL Masculino 2026 · Semana 1',            title:'Brasil × Polônia',               bettvPick:'Equilíbrio',   bettvConf:42, bettvReason:'H2H 50/50. Wilfredo León vs Leal — duelo técnico equilibradíssimo.', home:{name:'Brasil',      logo:null,sub:'Nº2 Mundial', pct:45},away:{name:'Polônia',  logo:null,sub:'Nº3 Mundial', pct:44},draw:11},
  ]},
  mma: { label:'MMA / UFC', items:[
    // ── UFC FN 271 — Seattle 28/03 (verificado CBS Sports / Sherdog) ──
    { id:'m-fn271', startTime:'2026-03-29T01:00:00Z', statusLabel:'28/03 · 22h PT · Climate Pledge · Seattle', competition:'UFC Fight Night 271 · Main Event', title:'Adesanya × Pyfer',    bettvPick:'Adesanya', bettvConf:58, bettvReason:'Adesanya ex-campeão MW Nº4 (24-5). Pyfer Nº14 (15-3) resiliente mas falta nível de elite.', home:{name:'I. Adesanya',  logo:'adesanya',sub:'Nº4 MW · 24-5',   pct:55},away:{name:'J. Pyfer',   logo:null,     sub:'Nº14 MW · 15-3',pct:35},draw:10},
    // ── UFC FN 272 — Las Vegas 04/04 ──
    { id:'m-fn272', startTime:'2026-04-05T03:00:00Z', statusLabel:'04/04 · 00h BRT · UFC Apex · Las Vegas',    competition:'UFC Fight Night 272 · Main Event', title:'Moicano × Duncan',    bettvPick:'Moicano',  bettvConf:60, bettvReason:'Moicano Nº11 (20-7) mais experiente. Duncan 15-2 surpreendente mas nível abaixo.', home:{name:'R. Moicano',  logo:null,     sub:'Nº11 LW · 20-7',pct:58},away:{name:'C. Duncan',  logo:null,     sub:'LW · 15-2',      pct:30},draw:12},
    // ── UFC 327 — Miami 11/04 ──
    { id:'m-ufc327', startTime:'2026-04-12T02:00:00Z', statusLabel:'11/04 · 23h BRT · Kaseya · Miami',          competition:'UFC 327 · Main Event',             title:'Prochazka × Ulberg', bettvPick:'Prochazka',bettvConf:55, bettvReason:'Prochazka ex-campeão LHW (32-5). Ulberg (14-1) 1º title shot. Prochazka mais experiente.', home:{name:'J. Prochazka',logo:'prochazka',sub:'32-5 · Ex-camp',  pct:54},away:{name:'C. Ulberg', logo:null,     sub:'14-1 · Nº3 LHW',pct:36},draw:10},
    // ── UFC FN 273 — 18/04 ──
    { id:'m-fn273', startTime:'2026-04-19T03:00:00Z', statusLabel:'18/04 · 00h BRT · Las Vegas',               competition:'UFC Fight Night 273 · Main Event', title:'Burns × Malott',     bettvPick:'Burns',    bettvConf:57, bettvReason:'Burns top 10 WW veterano. Malott em boa fase mas Burns mais completo tecnicamente.', home:{name:'G. Burns',    logo:null,     sub:'Top 10 WW',      pct:56},away:{name:'M. Malott', logo:null,     sub:'WW contender',  pct:33},draw:11},
    // ── UFC São Paulo — Maio ──
    { id:'m-bra', startTime:'2026-05-10T00:00:00Z', statusLabel:'09/05 · 21h BRT · São Paulo',                 competition:'UFC Fight Night Brasil · Main Event', title:'Pantoja × Royval II',bettvPick:'Pantoja',  bettvConf:67, bettvReason:'Alexandre Pantoja campeão peso-mosca. Defende cinturão em casa. Venceu Royval 2023.', home:{name:'A. Pantoja',  logo:'pantoja',sub:'Camp. Mosca',     pct:66},away:{name:'B. Royval', logo:null,     sub:'Top 5 Mosca',    pct:23},draw:11},
  ]},
  tenis: { label:'Tênis', items:[
    // ── Miami Open AO VIVO agora (21/03) ──
    { id:'t-dhu',  startTime:'2026-03-21T22:40:00Z', statusLabel:'AO VIVO · Miami Open R32 · Stadium', competition:'ATP Miami Open 2026 · R32', title:'Diallo × Humbert',           bettvPick:'Humbert',     bettvConf:62, bettvReason:'Humbert lidera 6-1 6-0. Favorito para vencer. Diallo em dificuldade total.', home:{name:'G. Diallo',    logo:null,sub:'ATP',        pct:20},away:{name:'U. Humbert',   logo:null,sub:'Nº18 ATP',   pct:70},draw:10},
    { id:'t-pgu',  startTime:'2026-03-21T23:05:00Z', statusLabel:'AO VIVO · Miami Open R32 · WTA',    competition:'WTA Miami Open 2026 · R32', title:'Parks × Gauff',              bettvPick:'Gauff',       bettvConf:65, bettvReason:'Coco Gauff Nº3 WTA em Miami. Parks WC joga bem em casa mas nível abaixo.', home:{name:'A. Parks',     logo:null,sub:'WC ATP',     pct:25},away:{name:'C. Gauff',    logo:'gauff',sub:'Nº3 WTA',    pct:65},draw:10},
    // ── Miami Open hoje noite ──
    { id:'t-tca',  startTime:'2026-03-21T23:30:00Z', statusLabel:'Hoje · 20h30 BRT · Miami Open R32', competition:'ATP Miami Open 2026 · R32', title:'Tiafoe × Cazaux',            bettvPick:'Tiafoe',      bettvConf:62, bettvReason:'Tiafoe Nº19 em casa é difícil de bater. Cazaux qualificado com boa fase.', home:{name:'F. Tiafoe',    logo:null,sub:'Nº19 ATP',   pct:62},away:{name:'A. Cazaux',   logo:null,sub:'ATP',        pct:28},draw:10},
    { id:'t-nci',  startTime:'2026-03-21T23:45:00Z', statusLabel:'Hoje · 20h45 BRT · Miami Open R32', competition:'ATP Miami Open 2026 · R32', title:'Nakashima × Cilic',          bettvPick:'Nakashima',   bettvConf:65, bettvReason:'Nakashima em grande fase. Cilic experiente mas no fim de carreira.', home:{name:'B. Nakashima', logo:null,sub:'Nº32 ATP',   pct:65},away:{name:'M. Cilic',    logo:null,sub:'ATP',        pct:25},draw:10},
    { id:'t-daz',  startTime:'2026-03-22T00:30:00Z', statusLabel:'Hoje · 21h30 BRT · Miami Open R32', competition:'ATP Miami Open 2026 · R32', title:'Damm Jr × Zverev',           bettvPick:'Zverev',      bettvConf:88, bettvReason:'Zverev Nº3 ATP. Damm Jr wildcard. Diferença enorme de nível.', home:{name:'M. Damm Jr',   logo:null,sub:'WC ATP',     pct:8}, away:{name:'A. Zverev',   logo:'zverev',sub:'Nº3 ATP',    pct:88},draw:4 },
    // ── Miami Open próximos dias ──
    { id:'t-sin-r3', startTime:'2026-03-23T17:00:00Z', statusLabel:'23/03 · 14h BRT · Miami Open R32',competition:'ATP Miami Open 2026 · R32', title:'Sinner × R32',               bettvPick:'Sinner',      bettvConf:85, bettvReason:'Jannik Sinner Nº2 favorito absoluto. Campeão Indian Wells 2026 sem perder set.', home:{name:'J. Sinner',    logo:'sinner',sub:'Nº2 ATP',    pct:85},away:{name:'Oponente R32',logo:null,sub:'ATP',        pct:10},draw:5 },
    { id:'t-alc-r3', startTime:'2026-03-23T20:00:00Z', statusLabel:'23/03 · 17h BRT · Miami Open R32',competition:'ATP Miami Open 2026 · R32', title:'Alcaraz × R32',              bettvPick:'Alcaraz',     bettvConf:82, bettvReason:'Carlos Alcaraz Nº1 ATP. 17-1 na temporada. Dominante em superfície dura.', home:{name:'C. Alcaraz',   logo:'alcaraz',sub:'Nº1 ATP',   pct:82},away:{name:'Oponente R32',logo:null,sub:'ATP',        pct:13},draw:5 },
    // ── QF Miami 25-26/03 ──
    { id:'t-mqf',  startTime:'2026-03-25T17:00:00Z', statusLabel:'25/03 · 14h BRT · Miami Open QF',  competition:'ATP Miami Open 2026 · QF', title:'Miami Open QF Alcaraz × Zverev',bettvPick:'Alcaraz',   bettvConf:58, bettvReason:'Alcaraz Nº1 vs Zverev Nº3. Clássico do circuito. Alcaraz mais agressivo em Miami.', home:{name:'C. Alcaraz',   logo:'alcaraz',sub:'Nº1 ATP · QF',pct:55},away:{name:'A. Zverev',   logo:'zverev',sub:'Nº3 ATP · QF', pct:35},draw:10},
    // ── SF Miami 27-28/03 ──
    { id:'t-msf',  startTime:'2026-03-27T17:00:00Z', statusLabel:'27/03 · 14h BRT · Miami Open SF',  competition:'ATP Miami Open 2026 · SF',  title:'Miami Open SF Sinner × Alcaraz',bettvPick:'Sinner',    bettvConf:47, bettvReason:'H2H histórico 6-6. Sinner campeão Miami 2024. Alcaraz venceu IW. Equilíbrio total.', home:{name:'J. Sinner',    logo:'sinner',sub:'Nº2 ATP · SF',pct:44},away:{name:'C. Alcaraz',   logo:'alcaraz',sub:'Nº1 ATP · SF', pct:38},draw:18},
    // ── Final Miami 29/03 ──
    { id:'t-mfin', startTime:'2026-03-29T17:00:00Z', statusLabel:'29/03 · 14h BRT · Final Miami',    competition:'ATP Miami Open 2026 · Final',title:'Final Miami Open ATP 2026',     bettvPick:'Alcaraz',     bettvConf:43, bettvReason:'Alcaraz busca Sunshine Double (IW+Miami). Sinner pode vencer — 2x finalista Miami.', home:{name:'C. Alcaraz',   logo:'alcaraz',sub:'Nº1 ATP · Final',pct:48},away:{name:'J. Sinner',    logo:'sinner',sub:'Nº2 ATP · Final',pct:38},draw:14},
    // ── Roland Garros ──
    { id:'t-rg',   startTime:'2026-05-25T09:00:00Z', statusLabel:'25/05 · Paris · Roland Garros',    competition:'Roland Garros 2026',         title:'Roland Garros 2026',            bettvPick:'Alcaraz',     bettvConf:41, bettvReason:'Alcaraz bicampeão RG. Saibro é sua superfície. Sinner e Zverev ameaças principais.', home:{name:'C. Alcaraz',   logo:'alcaraz',sub:'Bicampeão RG',  pct:38},away:{name:'J. Sinner',    logo:'sinner',sub:'Finalista 2025',pct:22},draw:40},
  ]},
  esports: { label:'E-sports', items:[
    { id:'e-l1', startTime:'2026-03-28T16:00:00Z', statusLabel:'28/03 · 13h BRT · Riot Arena SP', competition:'CBLOL 2026 · Etapa 1 · Rd 1', title:'LOUD × paiN Gaming',  bettvPick:'LOUD',  bettvConf:66, bettvReason:'LOUD campeã Copa CBLOL 2026. Bull e RedBert dominantes. paiN sem título desde 2023.', home:{name:'LOUD',          logo:'loud', sub:'Campeã Copa 2026',pct:62},away:{name:'paiN Gaming',  logo:null,sub:'4º Copa',     pct:24},draw:14},
    { id:'e-f1', startTime:'2026-03-28T18:00:00Z', statusLabel:'28/03 · 15h BRT · Riot Arena SP', competition:'CBLOL 2026 · Etapa 1 · Rd 1', title:'FURIA × RED Canids', bettvPick:'FURIA', bettvConf:54, bettvReason:'FURIA bootcampou Coreia pré-temporada. RED Canids inconstante na Copa 2026.', home:{name:'FURIA',         logo:'furia',sub:'Americas Cup',  pct:52},away:{name:'RED Canids',  logo:null,sub:'5º Copa',     pct:32},draw:16},
    { id:'e-l2', startTime:'2026-04-04T16:00:00Z', statusLabel:'04/04 · 13h BRT · Riot Arena SP', competition:'CBLOL 2026 · Etapa 1 · Rd 2', title:'LOUD × FURIA',      bettvPick:'LOUD',  bettvConf:55, bettvReason:'LOUD lidera H2H histórico vs FURIA (12V-8D). FURIA motivada pós-bootcamp Coreia.', home:{name:'LOUD',          logo:'loud', sub:'Campeã Copa',     pct:53},away:{name:'FURIA',       logo:'furia',sub:'Americas',    pct:35},draw:12},
    { id:'e-t1', startTime:'2026-04-05T08:00:00Z', statusLabel:'05/04 · 05h BRT · LCK Arena · Seoul', competition:'LCK Spring 2026 · Playoffs SF', title:'T1 × Gen.G',      bettvPick:'T1',    bettvConf:58, bettvReason:'T1 e Faker históricos em playoffs LCK. Gen.G com Chovy mas T1 tem mais experiência.', home:{name:'T1',            logo:'t1',   sub:'1º LCK',         pct:56},away:{name:'Gen.G',       logo:null,sub:'2º LCK',     pct:32},draw:12},
    { id:'e-cs', startTime:'2026-05-01T12:00:00Z', statusLabel:'01/05 · 09h BRT · CS2 Major',      competition:'CS2 Major 2026 · Quartas',    title:'NaVi × FaZe Clan',  bettvPick:'NaVi',  bettvConf:53, bettvReason:'s1mple ao melhor nível em 2026. FaZe forte mas NaVi tem mais títulos em Majors (3).', home:{name:'Natus Vincere', logo:null,sub:'Top 5 CS2',    pct:52},away:{name:'FaZe Clan',   logo:null,sub:'Top 5 CS2',  pct:35},draw:13},
  ]},
}

// ─── CRYPTO DATA ─────────────────────────────────────────────────────────────
const CRYPTO_DATA = [
  {id:'btc', symbol:'BTC', name:'Bitcoin',           price:87420,  change24h:+2.3, bettvPick:'ALTA',   bettvConf:67, bettvReason:'Dominância 54%. ETFs acumulando. Resistência $90k próxima.', logo:'https://cryptologos.cc/logos/bitcoin-btc-logo.png'},
  {id:'eth', symbol:'ETH', name:'Ethereum',           price:2015,   change24h:-0.8, bettvPick:'NEUTRO', bettvConf:45, bettvReason:'Luta com resistência $2100. Dencun ativo mas demanda fraca.', logo:'https://cryptologos.cc/logos/ethereum-eth-logo.png'},
  {id:'sol', symbol:'SOL', name:'Solana',             price:142.5,  change24h:+4.1, bettvPick:'ALTA',   bettvConf:62, bettvReason:'Ganha market share em DEX. Volume Raydium recorde semanal.', logo:'https://cryptologos.cc/logos/solana-sol-logo.png'},
  ...
  {id:'xrp', symbol:'XRP', name:'XRP',                price:0.524,  change24h:-1.4, bettvPick:'QUEDA',  bettvConf:52, bettvReason:'Perde momentum após alta de 40% em fevereiro. Correção provável.', logo:'https://cryptologos.cc/logos/xrp-xrp-logo.png'},
  ...
  {id:'ada', symbol:'ADA', name:'Cardano',            price:0.387,  change24h:+1.8, bettvPick:'ALTA',   bettvConf:48, bettvReason:'Chang 2 ativado. Staking crescendo.', logo:'https://cryptologos.cc/logos/cardano-ada-logo.png'},
  {id:'avax',symbol:'AVAX',name:'Avalanche',          price:24.8,   change24h:+2.9, bettvPick:'ALTA',   bettvConf:57, bettvReason:'Subnet Teleporter ganha adoção. TVL em recuperação.', logo:'https://cryptologos.cc/logos/avalanche-avax-logo.png'},
  {id:'doge',symbol:'DOGE',name:'Dogecoin',           price:0.178,  change24h:+5.2, bettvPick:'ALTA',   bettvConf:43, bettvReason:'Alta especulativa com buzz Musk/Tesla.', logo:'https://cryptologos.cc/logos/dogecoin-doge-logo.png'},
  {id:'dot', symbol:'DOT', name:'Polkadot',           price:5.82,   change24h:-0.5, bettvPick:'NEUTRO', bettvConf:44, bettvReason:'Polkadot 2.0 em implementação. Consolidação lateral.', logo:'https://cryptologos.cc/logos/polkadot-new-dot-logo.png'},
  {id:'link',symbol:'LINK',name:'Chainlink',          price:14.2,   change24h:+3.1, bettvPick:'ALTA',   bettvConf:59, bettvReason:'CCIP adotado por grandes bancos. Oráculos em alta demanda.', logo:'https://cryptologos.cc/logos/chainlink-link-logo.png'},
  {id:'matic',symbol:'POL',name:'Polygon',            price:0.392,  change24h:-2.1, bettvPick:'QUEDA',  bettvConf:53, bettvReason:'Migração POL completa mas L2 perdendo para ARB.', logo:'https://cryptologos.cc/logos/polygon-matic-logo.png'},
  {id:'uni', symbol:'UNI', name:'Uniswap',            price:8.74,   change24h:+1.5, bettvPick:'ALTA',   bettvConf:50, bettvReason:'Uniswap v4 no ar. Volume DEX recorde.', logo:'https://cryptologos.cc/logos/uniswap-uni-logo.png'},
  {id:'near',symbol:'NEAR',name:'NEAR Protocol',      price:3.21,   change24h:+6.8, bettvPick:'ALTA',   bettvConf:61, bettvReason:'AI integrations ganhando tração. Sharding fase 3 entregue.', logo:'https://cryptologos.cc/logos/near-protocol-near-logo.png'},
  {id:'arb', symbol:'ARB', name:'Arbitrum',           price:0.481,  change24h:+2.4, bettvPick:'ALTA',   bettvConf:55, bettvReason:'Lidera L2 em TVL ($18B). Stylus VM atrai devs.', logo:'https://cryptologos.cc/logos/arbitrum-arb-logo.png'},
  {id:'op',  symbol:'OP',  name:'Optimism',           price:1.02,   change24h:+1.8, bettvPick:'ALTA',   bettvConf:51, bettvReason:'Superchain crescendo. Base usa OP Stack.', logo:'https://cryptologos.cc/logos/optimism-ethereum-op-logo.png'},
  {id:'sui', symbol:'SUI', name:'Sui',                price:2.84,   change24h:+7.3, bettvPick:'ALTA',   bettvConf:65, bettvReason:'Maior ganhador da semana. TVL DeFi triplica em 30 dias.', logo:'https://cryptologos.cc/logos/sui-sui-logo.png'},
  {id:'ton', symbol:'TON', name:'Toncoin',            price:3.74,   change24h:+2.1, bettvPick:'ALTA',   bettvConf:60, bettvReason:'Integração Telegram 900M usuários. Mini-apps em explosão.', logo:'https://cryptologos.cc/logos/toncoin-ton-logo.png'},
  {id:'apt', symbol:'APT', name:'Aptos',              price:5.67,   change24h:+3.2, bettvPick:'ALTA',   bettvConf:54, bettvReason:'DeFi TVL em máxima histórica. Integração Google Cloud.', logo:'https://cryptologos.cc/logos/aptos-apt-logo.png'},
  {id:'tia', symbol:'TIA', name:'Celestia',           price:3.87,   change24h:+5.1, bettvPick:'ALTA',   bettvConf:58, bettvReason:'Modular blockchain em alta adoção. Rollups migrando.', logo:'https://cryptologos.cc/logos/celestia-tia-logo.png'},
  {id:'sei', symbol:'SEI', name:'Sei',                price:0.247,  change24h:+8.2, bettvPick:'ALTA',   bettvConf:62, bettvReason:'SEI v2 paralelização. L1 mais rápido para trading.', logo:'https://cryptologos.cc/logos/sei-sei-logo.png'},
  {id:'inj', symbol:'INJ', name:'Injective',          price:18.4,   change24h:+4.5, bettvPick:'ALTA',   bettvConf:59, bettvReason:'Lidera DeFi em trading perpétuo. Cosmos integrado.', logo:'https://cryptologos.cc/logos/injective-inj-logo.png'},
  {id:'rndr',symbol:'RNDR',name:'Render',             price:4.92,   change24h:+5.7, bettvPick:'ALTA',   bettvConf:60, bettvReason:'GPU computing para IA em boom. Parceria Nvidia.', logo:'https://cryptologos.cc/logos/render-token-rndr-logo.png'},
  {id:'fet', symbol:'FET', name:'Fetch.ai',           price:1.13,   change24h:+9.1, bettvPick:'ALTA',   bettvConf:63, bettvReason:'Narrativa AI+crypto forte. ASI Alliance em expansão.', logo:'https://cryptologos.cc/logos/fetch-ai-fet-logo.png'},
  {id:'jup', symbol:'JUP', name:'Jupiter',            price:0.582,  change24h:+4.3, bettvPick:'ALTA',   bettvConf:57, bettvReason:'Maior DEX aggregator da Solana. Volume $1B/dia.', logo:'https://cryptologos.cc/logos/jupiter-jup-logo.png'},
  {id:'aave',symbol:'AAVE',name:'Aave',               price:162,    change24h:+2.5, bettvPick:'ALTA',   bettvConf:58, bettvReason:'$15B TVL líder DeFi lending. GHO stablecoin crescendo.', logo:'https://cryptologos.cc/logos/aave-aave-logo.png'},
  {id:'mkr', symbol:'MKR', name:'MakerDAO',           price:1240,   change24h:+1.9, bettvPick:'ALTA',   bettvConf:52, bettvReason:'DAI $8B circulação. Sky Protocol expansão ativa.', logo:'https://cryptologos.cc/logos/maker-mkr-logo.png'},
  {id:'stx', symbol:'STX', name:'Stacks',             price:0.847,  change24h:+3.6, bettvPick:'ALTA',   bettvConf:56, bettvReason:'Bitcoin DeFi ganha tração. sBTC lançado.', logo:'https://cryptologos.cc/logos/stacks-stx-logo.png'},
  {id:'kas', symbol:'KAS', name:'Kaspa',              price:0.082,  change24h:+4.2, bettvPick:'ALTA',   bettvConf:55, bettvReason:'PoW mais rápido do mundo. Mineradores migrando do ETC.', logo:'https://cryptologos.cc/logos/kaspa-kas-logo.png'},
  {id:'blur',symbol:'BLUR',name:'Blur',               price:0.148,  change24h:+6.1, bettvPick:'ALTA',   bettvConf:49, bettvReason:'Marketplace NFT recupera volume. Airdrop no horizonte.', logo:'https://cryptologos.cc/logos/blur-blur-logo.png'},
  {id:'wld', symbol:'WLD', name:'Worldcoin',          price:1.42,   change24h:-3.1, bettvPick:'QUEDA',  bettvConf:54, bettvReason:'Preocupações regulatórias na Europa. Pressão de insiders.', logo:'https://cryptologos.cc/logos/worldcoin-wld-logo.png'},
  {id:'atom',symbol:'ATOM',name:'Cosmos',             price:4.12,   change24h:-1.0, bettvPick:'NEUTRO', bettvConf:42, bettvReason:'IBC crescendo mas inflacionário. Sem catalisador.', logo:'https://cryptologos.cc/logos/cosmos-atom-logo.png'},
  {id:'ltc', symbol:'LTC', name:'Litecoin',           price:76.3,   change24h:+0.9, bettvPick:'NEUTRO', bettvConf:41, bettvReason:'Segue BTC. Halving 2027 no radar.', logo:'https://cryptologos.cc/logos/litecoin-ltc-logo.png'},
  {id:'fil', symbol:'FIL', name:'Filecoin',           price:3.15,   change24h:-1.2, bettvPick:'NEUTRO', bettvConf:43, bettvReason:'Armazenamento descentralizado sem catalisador. Lateral.', logo:'https://cryptologos.cc/logos/filecoin-fil-logo.png'},
  {id:'grt', symbol:'GRT', name:'The Graph',          price:0.134,  change24h:+3.4, bettvPick:'ALTA',   bettvConf:52, bettvReason:'Infraestrutura web3 crescendo com DeFi bull.', logo:'https://cryptologos.cc/logos/the-graph-grt-logo.png'},
  {id:'icp', symbol:'ICP', name:'Internet Computer',  price:8.24,   change24h:+2.0, bettvPick:'ALTA',   bettvConf:48, bettvReason:'Computação on-chain. Novos dApps lançados.', logo:'https://cryptologos.cc/logos/internet-computer-icp-logo.png'},
  {id:'hbar',symbol:'HBAR',name:'Hedera',             price:0.063,  change24h:+1.4, bettvPick:'ALTA',   bettvConf:47, bettvReason:'Governança enterprise IBM/Google. Tokenização RWA.', logo:'https://cryptologos.cc/logos/hedera-hbar-logo.png'},
  {id:'egld',symbol:'EGLD',name:'MultiversX',         price:27.4,   change24h:+2.8, bettvPick:'ALTA',   bettvConf:50, bettvReason:'DeFi crescendo. xPortal app com 2M usuários.', logo:'https://cryptologos.cc/logos/elrond-egld-logo.png'},
  {id:'algo',symbol:'ALGO',name:'Algorand',           price:0.162,  change24h:-0.8, bettvPick:'NEUTRO', bettvConf:39, bettvReason:'Sem catalisador. Parcerias governamentais não movem preço.', logo:'https://cryptologos.cc/logos/algorand-algo-logo.png'},
  {id:'sand',symbol:'SAND',name:'The Sandbox',        price:0.287,  change24h:+1.1, bettvPick:'NEUTRO', bettvConf:38, bettvReason:'Metaverse perdeu hype. Gaming parceria aquece levemente.', logo:'https://cryptologos.cc/logos/the-sandbox-sand-logo.png'},
  {id:'xlm', symbol:'XLM', name:'Stellar',            price:0.094,  change24h:+1.7, bettvPick:'NEUTRO', bettvConf:42, bettvReason:'Pagamentos internacionais estáveis. Sem catalisador.', logo:'https://cryptologos.cc/logos/stellar-xlm-logo.png'},
  {id:'crv', symbol:'CRV', name:'Curve',              price:0.342,  change24h:-0.7, bettvPick:'NEUTRO', bettvConf:44, bettvReason:'TVL estável $2.1B. Governança afasta especuladores.', logo:'https://cryptologos.cc/logos/curve-dao-token-crv-logo.png'},
  {id:'w',   symbol:'W',   name:'Wormhole',           price:0.192,  change24h:+3.8, bettvPick:'ALTA',   bettvConf:51, bettvReason:'Bridge: $50B+ volume. Adoção cross-chain crescendo.', logo:'https://cryptologos.cc/logos/wormhole-w-logo.png'},
  {id:'zk',  symbol:'ZK',  name:'ZKsync',             price:0.094,  change24h:-1.5, bettvPick:'NEUTRO', bettvConf:45, bettvReason:'L2 promissor mas concorrência com Starknet.', logo:'https://cryptologos.cc/logos/zksync-zk-logo.png'},
  {id:'bch', symbol:'BCH', name:'Bitcoin Cash',       price:336,    change24h:+1.4, bettvPick:'ALTA',   bettvConf:48, bettvReason:'Segue BTC. Momentum pós-halving ainda presente.', logo:'https://cryptologos.cc/logos/bitcoin-cash-bch-logo.png'},
  {id:'etc', symbol:'ETC', name:'Ethereum Classic',   price:18.6,   change24h:-0.3, bettvPick:'NEUTRO', bettvConf:38, bettvReason:'Estável. Movimentos seguem ETH.', logo:'https://cryptologos.cc/logos/ethereum-classic-etc-logo.png'},
  {id:'pyth',symbol:'PYTH',name:'Pyth Network',       price:0.312,  change24h:+2.7, bettvPick:'ALTA',   bettvConf:53, bettvReason:'Oráculo líder Solana. 200+ novos feeds adicionados.', logo:'https://cryptologos.cc/logos/pyth-network-pyth-logo.png'},
  {id:'snx', symbol:'SNX', name:'Synthetix',          price:1.28,   change24h:+1.3, bettvPick:'NEUTRO', bettvConf:42, bettvReason:'Perp trading v3 no ar mas concorrência com GMX.', logo:'https://cryptologos.cc/logos/synthetix-network-token-snx-logo.png'},
  {id:'vet', symbol:'VET', name:'VeChain',            price:0.028,  change24h:+0.5, bettvPick:'NEUTRO', bettvConf:40, bettvReason:'Supply chain blockchain com adoção empresarial.', logo:'https://cryptologos.cc/logos/vechain-vet-logo.png'},
  {id:'imx', symbol:'IMX', name:'Immutable X',        price:1.14,   change24h:+3.1, bettvPick:'ALTA',   bettvConf:51, bettvReason:'Gaming blockchain líder. Parceiros AAA crescendo.', logo:'https://cryptologos.cc/logos/immutable-x-imx-logo.png'},
]

// ─── MOEDAS DATA ──────────────────────────────────────────────────────────────
const MOEDAS_DATA = [
  {id:'usd', symbol:'USD', name:'Dólar Americano',    flag:'🇺🇸', priceBRL:5.12,   change24h:-0.3, bettvPick:'QUEDA',  bettvConf:55, bettvReason:'Fed mantém juros. Dados de emprego abaixo do esperado.'},
  {id:'eur', symbol:'EUR', name:'Euro',               flag:'🇪🇺', priceBRL:5.54,   change24h:+0.4, bettvPick:'ALTA',   bettvConf:52, bettvReason:'BCE sinalizou pausa nos cortes. Zona do euro cresce.'},
  {id:'gbp', symbol:'GBP', name:'Libra Esterlina',    flag:'🇬🇧', priceBRL:6.64,   change24h:+0.2, bettvPick:'ALTA',   bettvConf:50, bettvReason:'BOE conservador. Inflação UK em queda.'},
  {id:'jpy', symbol:'JPY', name:'Iene Japonês',       flag:'🇯🇵', priceBRL:0.034,  change24h:-0.5, bettvPick:'QUEDA',  bettvConf:57, bettvReason:'BOJ ainda dovish. Diferencial de juros EUA-Japão.'},
  {id:'cny', symbol:'CNY', name:'Yuan Chinês',        flag:'🇨🇳', priceBRL:0.707,  change24h:+0.1, bettvPick:'NEUTRO', bettvConf:48, bettvReason:'PBOC gerencia valorização. Estímulos fiscais ativos.'},
  {id:'chf', symbol:'CHF', name:'Franco Suíço',       flag:'🇨🇭', priceBRL:5.69,   change24h:+0.3, bettvPick:'ALTA',   bettvConf:54, bettvReason:'SNB comprador de ouro. Franco seguro em risco global.'},
  {id:'cad', symbol:'CAD', name:'Dólar Canadense',    flag:'🇨🇦', priceBRL:3.72,   change24h:-0.2, bettvPick:'NEUTRO', bettvConf:46, bettvReason:'Petróleo WTI estável. BOC em pausa. CAD lateral.'},
  {id:'aud', symbol:'AUD', name:'Dólar Australiano',  flag:'🇦🇺', priceBRL:3.25,   change24h:+0.6, bettvPick:'ALTA',   bettvConf:53, bettvReason:'Commodities em alta. RBA corta menos que esperado.'},
  {id:'brl', symbol:'BRL', name:'Real Brasileiro',    flag:'🇧🇷', priceBRL:1.00,   change24h:-0.4, bettvPick:'QUEDA',  bettvConf:56, bettvReason:'Fiscal preocupa. Copom mantém Selic 14.75%.'},
  {id:'mxn', symbol:'MXN', name:'Peso Mexicano',      flag:'🇲🇽', priceBRL:0.257,  change24h:-0.8, bettvPick:'QUEDA',  bettvConf:55, bettvReason:'Nearshoring desacelera. Banxico corta juros.'},
  {id:'ars', symbol:'ARS', name:'Peso Argentino',     flag:'🇦🇷', priceBRL:0.005,  change24h:-1.2, bettvPick:'QUEDA',  bettvConf:72, bettvReason:'Argentina: inflação 180% a.a. Desvalorização estrutural.'},
  {id:'clp', symbol:'CLP', name:'Peso Chileno',       flag:'🇨🇱', priceBRL:0.005,  change24h:-0.3, bettvPick:'NEUTRO', bettvConf:44, bettvReason:'Cobre estável. BCCh em corte gradual.'},
  {id:'krw', symbol:'KRW', name:'Won Coreano',        flag:'🇰🇷', priceBRL:0.019,  change24h:-0.4, bettvPick:'NEUTRO', bettvConf:45, bettvReason:'Samsung e SK Hynix em recuperação. BOK cauteloso.'},
  {id:'inr', symbol:'INR', name:'Rúpia Indiana',      flag:'🇮🇳', priceBRL:0.061,  change24h:-0.2, bettvPick:'QUEDA',  bettvConf:50, bettvReason:'RBI intervém mas pressão estrutural no déficit.'},
  {id:'sgd', symbol:'SGD', name:'Dólar de Singapura', flag:'🇸🇬', priceBRL:3.86,   change24h:+0.2, bettvPick:'ALTA',   bettvConf:51, bettvReason:'MAS aprecia SGD. Economia de Singapura resiliente.'},
  {id:'hkd', symbol:'HKD', name:'Dólar de Hong Kong', flag:'🇭🇰', priceBRL:0.658,  change24h:0.0,  bettvPick:'NEUTRO', bettvConf:95, bettvReason:'HKD atrelado ao USD. Sem variação esperada.'},
  {id:'sek', symbol:'SEK', name:'Coroa Sueca',        flag:'🇸🇪', priceBRL:0.468,  change24h:+0.4, bettvPick:'ALTA',   bettvConf:49, bettvReason:'Riksbank pausou cortes. Exportações em recuperação.'},
  {id:'nok', symbol:'NOK', name:'Coroa Norueguesa',   flag:'🇳🇴', priceBRL:0.450,  change24h:+0.3, bettvPick:'ALTA',   bettvConf:51, bettvReason:'Petróleo Brent apoia NOK. Norges Bank hawkish.'},
  {id:'pln', symbol:'PLN', name:'Zloty Polonês',      flag:'🇵🇱', priceBRL:1.254,  change24h:+0.5, bettvPick:'ALTA',   bettvConf:53, bettvReason:'Polônia cresce 3.1% no 1T26. NBP conservador.'},
  {id:'try', symbol:'TRY', name:'Lira Turca',         flag:'🇹🇷', priceBRL:0.147,  change24h:-1.3, bettvPick:'QUEDA',  bettvConf:70, bettvReason:'Turquia: inflação 40%+. TRY em desvalorização.'},
  {id:'rub', symbol:'RUB', name:'Rublo Russo',        flag:'🇷🇺', priceBRL:0.056,  change24h:-0.9, bettvPick:'QUEDA',  bettvConf:66, bettvReason:'Sanções ocidentais e inflação persistente.'},
  {id:'zar', symbol:'ZAR', name:'Rand Sul-Africano',  flag:'🇿🇦', priceBRL:0.275,  change24h:+0.7, bettvPick:'ALTA',   bettvConf:50, bettvReason:'Ouro e platina valorizam. Estabilidade política.'},
  {id:'thb', symbol:'THB', name:'Baht Tailandês',     flag:'🇹🇭', priceBRL:0.152,  change24h:+0.2, bettvPick:'NEUTRO', bettvConf:44, bettvReason:'BOT estável. Turismo tailandês em recuperação.'},
  {id:'myr', symbol:'MYR', name:'Ringgit Malaio',     flag:'🇲🇾', priceBRL:1.142,  change24h:+0.5, bettvPick:'ALTA',   bettvConf:51, bettvReason:'BNM hawkish. Exportações semicondutores em alta.'},
  {id:'aed', symbol:'AED', name:'Dirham dos EAU',     flag:'🇦🇪', priceBRL:1.393,  change24h:-0.1, bettvPick:'NEUTRO', bettvConf:90, bettvReason:'AED atrelado ao USD. Dubai estável.'},
  {id:'sar', symbol:'SAR', name:'Riyal Saudita',      flag:'🇸🇦', priceBRL:1.368,  change24h:-0.1, bettvPick:'NEUTRO', bettvConf:88, bettvReason:'SAR atrelado ao USD. ARAMCO apoia reservas.'},
  {id:'ils', symbol:'ILS', name:'Shekel Israelense',  flag:'🇮🇱', priceBRL:1.40,   change24h:-0.4, bettvPick:'NEUTRO', bettvConf:46, bettvReason:'BOI intervém. Risco geopolítico mantém volatilidade.'},
  {id:'cop', symbol:'COP', name:'Peso Colombiano',    flag:'🇨🇴', priceBRL:0.001,  change24h:-0.5, bettvPick:'QUEDA',  bettvConf:51, bettvReason:'Petróleo recua. BanRep corta juros.'},
  {id:'pen', symbol:'PEN', name:'Sol Peruano',        flag:'🇵🇪', priceBRL:1.37,   change24h:+0.1, bettvPick:'NEUTRO', bettvConf:43, bettvReason:'Peru: mineração estável. BCRP mantém juros.'},
  {id:'nzd', symbol:'NZD', name:'Dólar Neozelandês',  flag:'🇳🇿', priceBRL:2.96,   change24h:+0.3, bettvPick:'ALTA',   bettvConf:48, bettvReason:'RBNZ pausou cortes. Exportações agro em recuperação.'},
  {id:'czk', symbol:'CZK', name:'Coroa Tcheca',       flag:'🇨🇿', priceBRL:0.219,  change24h:+0.3, bettvPick:'ALTA',   bettvConf:48, bettvReason:'CNB em pausa. Economia tcheca resiliente.'},
  {id:'huf', symbol:'HUF', name:'Forint Húngaro',     flag:'🇭🇺', priceBRL:0.014,  change24h:-0.6, bettvPick:'QUEDA',  bettvConf:52, bettvReason:'MNB corta juros agressivamente. HUF volátil.'},
  {id:'dkk', symbol:'DKK', name:'Coroa Dinamarquesa', flag:'🇩🇰', priceBRL:0.743,  change24h:+0.4, bettvPick:'ALTA',   bettvConf:50, bettvReason:'DKK atrelado ao EUR. Segue movimento europeu.'},
  {id:'uah', symbol:'UAH', name:'Hryvnia Ucraniana',  flag:'🇺🇦', priceBRL:0.123,  change24h:-0.6, bettvPick:'QUEDA',  bettvConf:65, bettvReason:'Ucrânia: guerra e instabilidade. UAH em queda.'},
  {id:'qar', symbol:'QAR', name:'Riyal Catarí',       flag:'🇶🇦', priceBRL:1.403,  change24h:0.0,  bettvPick:'NEUTRO', bettvConf:92, bettvReason:'QAR atrelado ao USD. Qatar apoia com fundo soberano.'},
  {id:'idr', symbol:'IDR', name:'Rupia Indonésia',    flag:'🇮🇩', priceBRL:0.0003, change24h:-0.4, bettvPick:'NEUTRO', bettvConf:43, bettvReason:'BI intervém para estabilizar. Comodities sustentam.'},
  {id:'php', symbol:'PHP', name:'Peso Filipino',      flag:'🇵🇭', priceBRL:0.087,  change24h:-0.3, bettvPick:'NEUTRO', bettvConf:44, bettvReason:'BSP cortou juros. Remessas sustentam PHP.'},
  {id:'pkr', symbol:'PKR', name:'Rupia Paquistanesa', flag:'🇵🇰', priceBRL:0.018,  change24h:-0.7, bettvPick:'QUEDA',  bettvConf:64, bettvReason:'Crise de dívida. FMI empresta mas PKR fraco.'},
  {id:'egp', symbol:'EGP', name:'Libra Egípcia',      flag:'🇪🇬', priceBRL:0.102,  change24h:-0.5, bettvPick:'QUEDA',  bettvConf:60, bettvReason:'CBE corta juros mas inflação persiste.'},
  {id:'ngn', symbol:'NGN', name:'Naira Nigeriana',    flag:'🇳🇬', priceBRL:0.003,  change24h:-1.0, bettvPick:'QUEDA',  bettvConf:68, bettvReason:'Nigéria: escassez de dólares. Inflação 28%.'},
  {id:'kwd', symbol:'KWD', name:'Dinar Kuwaitiano',   flag:'🇰🇼', priceBRL:16.85,  change24h:-0.1, bettvPick:'NEUTRO', bettvConf:85, bettvReason:'KWD mais valorizada do mundo. Atrelada ao cesto.'},
  {id:'twd', symbol:'TWD', name:'Dólar de Taiwan',    flag:'🇹🇼', priceBRL:0.159,  change24h:+0.3, bettvPick:'ALTA',   bettvConf:52, bettvReason:'TSMC exportações recordes. Tensão China monitorada.'},
  {id:'bdt', symbol:'BDT', name:'Taka Bangladeshi',   flag:'🇧🇩', priceBRL:0.046,  change24h:-0.4, bettvPick:'NEUTRO', bettvConf:42, bettvReason:'Bangladesh: exportações têxteis estáveis.'},
  {id:'kes', symbol:'KES', name:'Shilling Queniano',  flag:'🇰🇪', priceBRL:0.040,  change24h:+0.3, bettvPick:'NEUTRO', bettvConf:45, bettvReason:'Quênia: inflação em queda. KES em recuperação.'},
  {id:'jod', symbol:'JOD', name:'Dinar Jordaniano',   flag:'🇯🇴', priceBRL:7.22,   change24h:0.0,  bettvPick:'NEUTRO', bettvConf:88, bettvReason:'JOD atrelado ao USD. CBJ defende paridade.'},
  {id:'omr', symbol:'OMR', name:'Rial Omanense',      flag:'🇴🇲', priceBRL:13.29,  change24h:-0.1, bettvPick:'NEUTRO', bettvConf:85, bettvReason:'OMR atrelado ao USD. Petróleo sustenta reservas.'},
  {id:'bam', symbol:'BAM', name:'Marco Bósnio',       flag:'🇧🇦', priceBRL:2.83,   change24h:+0.4, bettvPick:'ALTA',   bettvConf:49, bettvReason:'BAM atrelado ao EUR. Segue valorização europeia.'},
  {id:'vnd', symbol:'VND', name:'Dong Vietnamita',    flag:'🇻🇳', priceBRL:0.0002, change24h:0.0,  bettvPick:'NEUTRO', bettvConf:80, bettvReason:'SBV gerencia câmbio. VND quasi-fixo ao USD.'},
  {id:'myr2',symbol:'SGD', name:'Dólar de Singapura 2',flag:'🇸🇬',priceBRL:3.86,   change24h:+0.2, bettvPick:'ALTA',   bettvConf:51, bettvReason:'MAS aprecia SGD. Economia resiliente.'},
]
