...
const IcoMMA       = ({size=16,color='currentColor'}) => <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{display:'block',flexShrink:0}}><path d="M9 4C7.3 4 6 5.3 6 7v.5c-.8.2-1.5 1-1.5 1.9v3.2c0 .9.7 1.6 1.5 1.8V16c0 1.1.9 2 2 2h5c1.1 0 2-.9 2-2v-2.6c.8-.2 1.5-.9 1.5-1.8V9.5c0-.9-.6-1.7-1.5-1.9V7c0-1.7-1.3-3-3-3-.8 0-1.5.3-2 .8C10.5 4.3 9.8 4 9 4z"/></svg>
...
const ESPORTES = {
  futebol: { label:'Futebol', items:[
    // Brasileirão — Rodada 8 (hoje 21/03)
    { id:'f1',  status:'live',     startTime:'2026-03-21T21:30:00-03:00', statusLabel:'Hoje · 21h30 · Morumbis',           competition:'Brasileirão · Rd 8',      title:'São Paulo × Palmeiras',         subtitle:'Choque-Rei pela liderança',              bettvPick:'Palmeiras',   bettvConf:62, bettvReason:'Palmeiras lidera com saldo +11. SP sem Lucas Moura. Palmas venceu 7 dos últimos 10 clássicos.',     home:{name:'São Paulo',      sub:'2º · 16pts', pct:31}, away:{name:'Palmeiras',     sub:'1º · 16pts', pct:48}, draw:21 },
    { id:'f2',  status:'live',     startTime:'2026-03-21T20:30:00-03:00', statusLabel:'Hoje · 20h30 · Neo Química',         competition:'Brasileirão · Rd 8',      title:'Corinthians × Flamengo',        subtitle:'Clássico nacional em São Paulo',          bettvPick:'Flamengo',    bettvConf:44, bettvReason:'Corinthians 5 sem vencer, mas joga em casa. Flamengo em 4 vitórias seguidas.',                   home:{name:'Corinthians',    sub:'9º · 8pts',  pct:30}, away:{name:'Flamengo',      sub:'4º · 13pts', pct:44}, draw:26 },
    { id:'f3',  status:'live',     startTime:'2026-03-21T19:00:00-03:00', statusLabel:'Hoje · 19h · Arena Fonte Nova',      competition:'Brasileirão · Rd 8',      title:'Bahia × Botafogo',              subtitle:'Nordeste vs atual campeão',              bettvPick:'Bahia',       bettvConf:51, bettvReason:'Bahia 3º (14pts) joga em casa com calor e altitude a favor. Botafogo irregular longe do RJ.',      home:{name:'Bahia',          sub:'3º · 14pts', pct:50}, away:{name:'Botafogo',      sub:'6º · 12pts', pct:27}, draw:23 },
    // Brasileirão — Rodada 9 (01-02/04)
    { id:'f4',  status:'upcoming', startTime:'2026-04-01T20:00:00-03:00', statusLabel:'01/04 · 20h · Beira-Rio',            competition:'Brasileirão · Rd 9',      title:'Internacional × São Paulo',     subtitle:'Beira-Rio recebe o Tricolor',            bettvPick:'São Paulo',   bettvConf:49, bettvReason:'SP 2º lugar vem de derrota no clássico. Inter em casa com apoio do Beira-Rio. H2H equilibrado.',   home:{name:'Internacional',  sub:'12º · 7pts', pct:38}, away:{name:'São Paulo',     sub:'2º · 16pts', pct:42}, draw:20 },
    { id:'f5',  status:'upcoming', startTime:'2026-04-01T21:30:00-03:00', statusLabel:'01/04 · 21h30 · Neo Química',        competition:'Brasileirão · Rd 9',      title:'Corinthians × Mirassol',        subtitle:'Timão tenta sair do Z-4',               bettvPick:'Corinthians', bettvConf:58, bettvReason:'Mirassol recém-promovido ainda se adaptando. Corinthians pressionado precisa dos 3pts em casa.',   home:{name:'Corinthians',    sub:'9º · 8pts',  pct:54}, away:{name:'Mirassol',      sub:'19º · 3pts', pct:20}, draw:26 },
    { id:'f6',  status:'upcoming', startTime:'2026-04-02T16:00:00-03:00', statusLabel:'02/04 · 16h · Arena MRV',            competition:'Brasileirão · Rd 9',      title:'Atlético-MG × Flamengo',        subtitle:'Duelo de gigantes em BH',               bettvPick:'Flamengo',    bettvConf:47, bettvReason:'Atlético-MG oscila mas Arena MRV é fortaleza. Fla tem melhor elenco e sequência positiva.',        home:{name:'Atlético-MG',   sub:'8º · 10pts', pct:36}, away:{name:'Flamengo',      sub:'4º · 13pts', pct:44}, draw:20 },
    // Copa Libertadores — Corinthians Grupo E
    { id:'f7',  status:'upcoming', startTime:'2026-04-09T21:00:00-03:00', statusLabel:'09/04 · 21h · Buenos Aires',         competition:'Copa Libertadores · Gr.E', title:'Platense × Corinthians',        subtitle:'Estreia corintiana na Libertadores',     bettvPick:'Empate',      bettvConf:41, bettvReason:'Corinthians forte mas fora de casa. Platense defensivo em Buenos Aires. H2H inexistente.',          home:{name:'Platense',       sub:'Gr.E · ARG', pct:35}, away:{name:'Corinthians',   sub:'Gr.E · BRA', pct:38}, draw:27 },
    // Premier League UK
    { id:'f8',  status:'upcoming', startTime:'2026-03-22T12:30:00+00:00', statusLabel:'22/03 · 09h30 · Old Trafford',       competition:'Premier League · Rd 30',  title:'Man. United × Arsenal',         subtitle:'Clássico inglês — Manchester vs Gunners',bettvPick:'Arsenal',     bettvConf:61, bettvReason:'Arsenal 1º, 67pts. Man.Utd em 8º, inconsistente em casa. Odegaard e Saka na melhor fase da temporada.', home:{name:'Man. United',   sub:'8º · 44pts', pct:25}, away:{name:'Arsenal',       sub:'1º · 67pts', pct:58}, draw:17 },
    // La Liga Espanha
    { id:'f9',  status:'upcoming', startTime:'2026-03-22T16:00:00+00:00', statusLabel:'22/03 · 13h · Bernabéu',             competition:'La Liga · Jornada 29',    title:'Real Madrid × Barcelona',       subtitle:'El Clásico — Decisivo na liderança',    bettvPick:'Real Madrid', bettvConf:48, bettvReason:'Real Madrid em casa no Bernabéu. Barça lidera mas viaja. Mbappé vs Yamal é o duelo do século.',       home:{name:'Real Madrid',   sub:'2º · 62pts', pct:46}, away:{name:'Barcelona',     sub:'1º · 65pts', pct:36}, draw:18 },
    // Bundesliga Alemanha
    { id:'f10', status:'upcoming', startTime:'2026-03-21T17:30:00+00:00', statusLabel:'21/03 · 14h30 · Allianz Arena',      competition:'Bundesliga · Rd 27',      title:'Bayern Munich × Bayer Leverkusen', subtitle:'Duelo pelo título alemão',           bettvPick:'Bayern',      bettvConf:55, bettvReason:'Bayern em casa com Kane artilheiro. Leverkusen campeão em 2024/25 mas oscila fora. H2H: Bayer 3V-2E-5D.', home:{name:'Bayern Munich', sub:'1º · 63pts', pct:52}, away:{name:'Bayer Leverkusen',sub:'2º · 58pts',pct:28},draw:20 },
    // Champions League
    { id:'f11', status:'upcoming', startTime:'2026-04-07T20:00:00+00:00', statusLabel:'07/04 · 17h · Etihad',               competition:'Champions League · QF',   title:'Man. City × PSG',               subtitle:'Quartas — Duelo de magnatas',           bettvPick:'Man. City',   bettvConf:52, bettvReason:'Man. City em casa, 5 finais em 6 anos. PSG eliminado por City em 2021. H2H: City 4V-1E-1D.',          home:{name:'Man. City',     sub:'QF · ING',   pct:50}, away:{name:'PSG',            sub:'QF · FRA',   pct:30}, draw:20 },
    { id:'f12', status:'upcoming', startTime:'2026-04-08T20:00:00+00:00', statusLabel:'08/04 · 17h · Maracanã Digital',     competition:'Champions League · QF',   title:'Real Madrid × Inter Milão',     subtitle:'Quartas — Final antecipada',           bettvPick:'Real Madrid', bettvConf:54, bettvReason:'Real Madrid tem melhor retrospecto em UCL (15 títulos). Inter finalista 2023. Bernabéu é fortaleza.',   home:{name:'Real Madrid',   sub:'QF · ESP',   pct:52}, away:{name:'Inter Milão',    sub:'QF · ITA',   pct:28}, draw:20 },
  ]},
  basquete: { label:'Basquete', items:[
    // NBB Brasil — Rd 30 (ao vivo hoje)
    { id:'b1',  status:'live',     startTime:'2026-03-21T19:00:00-03:00', statusLabel:'Hoje · 19h · Ibirapuera',            competition:'NBB 2025/26 · Rd 30',    title:'Flamengo × Pinheiros',          subtitle:'Líder recebe o Mengão em ascensão',     bettvPick:'Flamengo',    bettvConf:61, bettvReason:'Fla virou 15pts de desvantagem recentemente. Pinheiros 1º mas Fla crescendo com melhor ataque.', home:{name:'Flamengo',      sub:'3º · 21V',   pct:58}, away:{name:'Pinheiros',     sub:'1º · 26V',   pct:30}, draw:12 },
    { id:'b2',  status:'live',     startTime:'2026-03-21T20:00:00-03:00', statusLabel:'Hoje · 20h · Arena Caixa',           competition:'NBB 2025/26 · Rd 30',    title:'Sesi Franca × Fortaleza BC',   subtitle:'Tetracampeão busca mais vitória',       bettvPick:'Sesi Franca', bettvConf:78, bettvReason:'31pts de Lucas Dias na última rodada. Franca venceu 8 dos últimos 10 jogos.',                    home:{name:'Sesi Franca',   sub:'2º · 24V',   pct:72}, away:{name:'Fortaleza BC',  sub:'9º · 14V',   pct:16}, draw:12 },
    // NBA — jogos de hoje (21/03) e amanhã, dados reais
    { id:'b3',  status:'upcoming', startTime:'2026-03-21T21:00:00-03:00', statusLabel:'Hoje · 21h · Capital One Arena',     competition:'NBA · Regular Season',   title:'Washington × OKC Thunder',     subtitle:'Thunder favorito absoluto em DC',       bettvPick:'OKC Thunder', bettvConf:92, bettvReason:'OKC tem 95.7% de probabilidade pela SportRadar. Líder do Oeste vs pior equipe da liga.',             home:{name:'Washington',    sub:'Conf. Leste', pct:5},  away:{name:'OKC Thunder',   sub:'1º Oeste',   pct:92}, draw:3  },
    { id:'b4',  status:'upcoming', startTime:'2026-03-21T23:00:00-03:00', statusLabel:'Hoje · 23h · Smoothie King',         competition:'NBA · Regular Season',   title:'New Orleans × Cleveland',      subtitle:'Cavaliers buscam vaga nos playoffs',    bettvPick:'Cleveland',   bettvConf:58, bettvReason:'Cleveland 63.2% de probabilidade. Vine em 3V seguidas. Pelicans irregulares em casa.',              home:{name:'New Orleans',   sub:'Conf. Leste', pct:37}, away:{name:'Cleveland',     sub:'Conf. Leste', pct:58}, draw:5  },
    { id:'b5',  status:'upcoming', startTime:'2026-03-21T23:00:00-03:00', statusLabel:'Hoje · 23h · AmericanAirlines',      competition:'NBA · Regular Season',   title:'Charlotte × Memphis',          subtitle:'Hornets favoritos em casa',             bettvPick:'Charlotte',   bettvConf:88, bettvReason:'Charlotte com 92.5% de probabilidade. Memphis em derrocada, pior momento da temporada.',            home:{name:'Charlotte',     sub:'Conf. Leste', pct:89}, away:{name:'Memphis',       sub:'Conf. Oeste', pct:8},  draw:3  },
    { id:'b6',  status:'upcoming', startTime:'2026-03-21T23:00:00-03:00', statusLabel:'Hoje · 23h · Kaseya Center',         competition:'NBA · Regular Season',   title:'Orlando × LA Lakers',          subtitle:'Lakers em busca de playoff',            bettvPick:'LA Lakers',   bettvConf:54, bettvReason:'Lakers 58.6% pela SportRadar. LeBron e AD dominam. Orlando perdeu 4 dos últimos 5.',              home:{name:'Orlando',       sub:'Conf. Leste', pct:42}, away:{name:'LA Lakers',     sub:'Conf. Oeste', pct:54}, draw:4  },
    { id:'b7',  status:'upcoming', startTime:'2026-03-22T00:00:00-03:00', statusLabel:'Hoje · 00h · Toyota Center',         competition:'NBA · Regular Season',   title:'Houston × Miami',              subtitle:'Rockets em casa, favoritados',          bettvPick:'Houston',     bettvConf:53, bettvReason:'Houston 57.4% pela SportRadar. Rockets venceu últimos 5 em casa. Miami sem Tyler Herro lesionado.',  home:{name:'Houston',       sub:'Conf. Oeste', pct:54}, away:{name:'Miami',          sub:'Conf. Leste', pct:43}, draw:3  },
    // Euroliga — basquete europeu
    { id:'b8',  status:'upcoming', startTime:'2026-04-04T20:00:00+02:00', statusLabel:'04/04 · 15h · Parc dels Princes',    competition:'EuroLeague · Playoffs R1', title:'Barcelona × Real Madrid',     subtitle:'Clássico da EuroLeague',               bettvPick:'Real Madrid', bettvConf:52, bettvReason:'Real Madrid 6 títulos na Euroliga. Campazzo liderando. Barça em casa mas Real viaja melhor.',       home:{name:'Barcelona',     sub:'3º Euroliga', pct:45}, away:{name:'Real Madrid',   sub:'1º Euroliga', pct:47}, draw:8  },
  ]},
  volei: { label:'Vôlei', items:[
    { id:'v1',  status:'live',     startTime:'2026-03-21T21:00:00-03:00', statusLabel:'Hoje · 21h · Arena Paulo Skaf',      competition:'Superliga Masc. · Rd 10', title:'Joinville × Sada Cruzeiro',   subtitle:'Decacampeão visita Joinville',          bettvPick:'Sada Cruzeiro',bettvConf:67, bettvReason:'Sada Cruzeiro tem melhor defesa da liga. Wallace e Douglas Souza formam dupla dominante.',     home:{name:'Joinville',     sub:'6º lugar',   pct:25}, away:{name:'Sada Cruzeiro', sub:'1º lugar',   pct:65}, draw:10 },
    { id:'v2',  status:'live',     startTime:'2026-03-21T20:00:00-03:00', statusLabel:'Hoje · 20h · Ginásio Mineirinho',    competition:'Superliga Fem. · Rd 10', title:'Praia Clube × Sesc Flamengo', subtitle:'Duelo de gigantes pelo topo feminino',  bettvPick:'Sesc Flamengo',bettvConf:60, bettvReason:'Sesc com Bernardinho mais consistente. Praia Clube perde sets importantes nos momentos decisivos.',home:{name:'Praia Clube',   sub:'3º lugar',   pct:31}, away:{name:'Sesc Flamengo', sub:'1º lugar',   pct:57}, draw:12 },
    { id:'v3',  status:'upcoming', startTime:'2026-03-29T17:00:00-03:00', statusLabel:'29/03 · 17h · São Paulo',            competition:'Superliga Fem. · Semifinal',title:'Sesc Flamengo × Praia Clube',subtitle:'Semifinal Superliga Feminina ida',     bettvPick:'Sesc Flamengo',bettvConf:57, bettvReason:'Sesc favoritada. Praia Clube especialista em playoffs — venceu em 2023 e 2024. Série aberta.',   home:{name:'Sesc Flamengo', sub:'1º lugar',   pct:55}, away:{name:'Praia Clube',   sub:'3º lugar',   pct:30}, draw:15 },
    { id:'v4',  status:'upcoming', startTime:'2026-05-10T18:00:00-03:00', statusLabel:'10/05 · 18h · Belo Horizonte',      competition:'Superliga Masc. · Final',  title:'Sada Cruzeiro × Taubaté',    subtitle:'Projeção: Grande Final da Superliga',  bettvPick:'Sada Cruzeiro',bettvConf:63, bettvReason:'Sada favorito ao tricampeonato. Taubaté único rival histórico mas elenco desfalcado em 2026.',  home:{name:'Sada Cruzeiro', sub:'Favorito',   pct:62}, away:{name:'Taubaté',        sub:'Vice fav.',  pct:28}, draw:10 },
    // Vôlei internacional — Liga das Nações (VNL)
    { id:'v5',  status:'upcoming', startTime:'2026-06-03T19:00:00+09:00', statusLabel:'03/06 · 07h · Tóquio · VNL',        competition:'VNL Masc. 2026 · Semana 1',title:'Brasil × Japão',              subtitle:'VNL — Brasil defende liderança histórica',bettvPick:'Brasil',    bettvConf:72, bettvReason:'Brasil top 3 no ranking mundial. Japão joga em casa (pressão), mas Leal e Flávio são superiores.', home:{name:'Japão',          sub:'Nº5 Mundial', pct:22}, away:{name:'Brasil',         sub:'Nº2 Mundial', pct:68}, draw:10 },
    { id:'v6',  status:'upcoming', startTime:'2026-06-05T20:00:00+09:00', statusLabel:'05/06 · 08h · Tóquio · VNL',        competition:'VNL Masc. 2026 · Semana 1',title:'Brasil × Polônia',            subtitle:'VNL — Duelo histórico dos rivais',       bettvPick:'Empate',      bettvConf:38, bettvReason:'Brasil e Polônia H2H em 50/50 na VNL histórica. Wilfredo León vs Kurek, equilíbrio técnico.', home:{name:'Polônia',        sub:'Nº3 Mundial', pct:45}, away:{name:'Brasil',         sub:'Nº2 Mundial', pct:44}, draw:11 },
  ]},
  mma: { label:'MMA / UFC', items:[
    { id:'m1',  status:'live',     startTime:'2026-03-21T17:00:00+00:00', statusLabel:'Hoje · UFC FN 270 · Londres',        competition:'UFC Fight Night 270',    title:'Evloev × Murphy',              subtitle:'Dois invictos pelo cinturão',           bettvPick:'Decisão',     bettvConf:55, bettvReason:'Evloev 19-0 vs Murphy 17-0. Britânico em casa com público a favor. Estilos técnicos — decisão provável.', home:{name:'L. Murphy',    sub:'17-0 · Pena',pct:44}, away:{name:'M. Evloev',    sub:'19-0 · Pena',pct:44}, draw:12 },
    { id:'m2',  status:'upcoming', startTime:'2026-03-28T22:00:00-05:00', statusLabel:'28/03 · Las Vegas · FN 271',         competition:'UFC Fight Night 271',    title:'Adesanya × Pyfer',             subtitle:'Ex-campeão busca retorno ao top 5',     bettvPick:'Adesanya',    bettvConf:58, bettvReason:'Melhor alcance, KO power e experiência de campeonato. Pyfer pressiona mas carece de resistência.',   home:{name:'I. Adesanya',  sub:'25-4 · MW',  pct:55}, away:{name:'J. Pyfer',     sub:'13-2 · Top15',pct:34}, draw:11 },
    { id:'m3',  status:'upcoming', startTime:'2026-04-12T22:00:00-05:00', statusLabel:'12/04 · Las Vegas · UFC 315',        competition:'UFC 315',               title:'Poirier × Holloway III',       subtitle:'Trilogia pelo cinturão peso-pena',      bettvPick:'Holloway',    bettvConf:52, bettvReason:'Holloway H2H 2V-0D sobre Poirier. Mais consistente no striking. Poirier em retorno arriscado.',     home:{name:'D. Poirier',   sub:'Ex-camp · LW',pct:36},away:{name:'M. Holloway',  sub:'Camp. Pena', pct:52}, draw:12 },
    { id:'m4',  status:'upcoming', startTime:'2026-04-26T20:00:00+04:00', statusLabel:'26/04 · Abu Dhabi · UFC 316',        competition:'UFC 316',               title:'Makhachev × Oliveira II',      subtitle:'Revanche pelo cinturão leve',          bettvPick:'Makhachev',   bettvConf:64, bettvReason:'Makhachev dominou o 1º duelo por decisão. Islam mais completo no grappling com Dagestani game plan.',  home:{name:'I. Makhachev', sub:'Camp. Leve', pct:62}, away:{name:'C. Oliveira',  sub:'Do Bronx · 35-9',pct:29},draw:9  },
    { id:'m5',  status:'upcoming', startTime:'2026-05-10T20:00:00-05:00', statusLabel:'10/05 · São Paulo · UFC FN 272',     competition:'UFC Fight Night 272',   title:'Pantoja × Royval II',          subtitle:'Brasil recebe o campeão peso-mosca',   bettvPick:'Pantoja',     bettvConf:67, bettvReason:'Pantoja campeão venceu Royval em 2023. Luta em SP gera pressão extra para o brasileiro. Favorito claro.', home:{name:'A. Pantoja',   sub:'Camp. Mosca',pct:66}, away:{name:'B. Royval',    sub:'Top 5 · 18-8',pct:23},draw:11 },
    { id:'m6',  status:'upcoming', startTime:'2026-05-24T22:00:00-05:00', statusLabel:'24/05 · Las Vegas · UFC 317',        competition:'UFC 317',               title:'Pereira × Prochazka III',      subtitle:'Trilogia histórica dos pesados-leves',  bettvPick:'Pereira',     bettvConf:55, bettvReason:'Poatan venceu os 2 duelos mas Prochazka é imprevisível. Quem acertar o nocaute primeiro vence.',      home:{name:'A. Pereira',   sub:'Camp. LHW', pct:53}, away:{name:'J. Prochazka',sub:'2× vice',     pct:38}, draw:9  },
  ]},
  tenis: { label:'Tênis', items:[
    // Miami Open 2026 — 21/03 quartas em andamento
    { id:'t1',  status:'live',     startTime:'2026-03-21T13:00:00-05:00', statusLabel:'Hoje · Miami Open · Quartas',        competition:'ATP Miami 2026 · QF',   title:'Sinner × Tsitsipas',           subtitle:'Sinner busca semifinal em Miami',       bettvPick:'Sinner',      bettvConf:74, bettvReason:'Sinner venceu IW sem perder set. Tsitsipas surpreendeu De Minaur mas Jannik é nível superior.',    home:{name:'J. Sinner',    sub:'Nº2 · IW Camp.',pct:73},away:{name:'S. Tsitsipas',sub:'Nº7 ATP',     pct:19}, draw:8  },
    { id:'t2',  status:'live',     startTime:'2026-03-21T15:00:00-05:00', statusLabel:'Hoje · Miami Open · Quartas',        competition:'ATP Miami 2026 · QF',   title:'Alcaraz × Fritz',              subtitle:'Espanha vs EUA nas quartas de Miami',  bettvPick:'Alcaraz',     bettvConf:66, bettvReason:'Alcaraz venceu Australian Open 2026 e chegou sem drop sets até aqui. Fritz resiliente mas outsider.',  home:{name:'C. Alcaraz',   sub:'Nº1 ATP',    pct:65}, away:{name:'T. Fritz',     sub:'Nº5 ATP',    pct:22}, draw:13 },
    { id:'t3',  status:'upcoming', startTime:'2026-03-27T13:00:00-05:00', statusLabel:'27/03 · Miami Open · Semifinal',    competition:'ATP Miami 2026 · SF',   title:'Sinner × Alcaraz',             subtitle:'Semifinal — Sunshine Double em jogo',  bettvPick:'Sinner',      bettvConf:47, bettvReason:'Sinner tem 2 finais e 1 título em Miami. Alcaraz venceu Indian Wells. H2H: 6-6 historicamente.',    home:{name:'J. Sinner',    sub:'Nº2 · Fav.',pct:44},  away:{name:'C. Alcaraz',   sub:'Nº1 · 2T 2026',pct:38},draw:18 },
    { id:'t4',  status:'upcoming', startTime:'2026-03-29T13:00:00-05:00', statusLabel:'29/03 · Miami Open · Final',        competition:'ATP Miami 2026 · Final', title:'Final Miami Open 2026',       subtitle:'Definindo o campeão do Sunshine Swing', bettvPick:'Alcaraz',     bettvConf:43, bettvReason:'Alcaraz já tem 2 títulos em 2026 (AO + IW). Sinner pode vencer mas pressão de ser Nº2 é maior.',    home:{name:'C. Alcaraz',   sub:'Nº1 ATP',    pct:48}, away:{name:'J. Sinner',    sub:'Nº2 ATP',    pct:38}, draw:14 },
    // Monte Carlo
    { id:'t5',  status:'upcoming', startTime:'2026-04-12T11:00:00+02:00', statusLabel:'12/04 · Monte Carlo · Masters',     competition:'ATP Monte Carlo · R1',  title:'Monte Carlo Masters 2026',    subtitle:'Início do swing de saibro europeu',    bettvPick:'Alcaraz',     bettvConf:44, bettvReason:'Alcaraz é rei do saibro (RG 2023-24). Sinner menos dominante no clay. Zverev é a principal ameaça.',home:{name:'C. Alcaraz',   sub:'Nº1 · Saibro',pct:42},away:{name:'J. Sinner',   sub:'Nº2 ATP',    pct:28}, draw:30 },
    // Roland Garros
    { id:'t6',  status:'upcoming', startTime:'2026-05-25T11:00:00+02:00', statusLabel:'25/05-07/06 · Paris',              competition:'Roland Garros 2026',    title:'Roland Garros 2026',           subtitle:'Grand Slam de saibro — o maior do ano', bettvPick:'Alcaraz',     bettvConf:41, bettvReason:'Alcaraz bicampeão em Paris (2023-24). Saibro é sua superfície favorita. Sinner e Zverev podem ameaçar.',home:{name:'C. Alcaraz',  sub:'Bicampeão Paris',pct:38},away:{name:'J. Sinner',  sub:'Finalista 2025',pct:22},draw:40 },
    // WTA Miami
    { id:'t7',  status:'upcoming', startTime:'2026-03-26T11:00:00-05:00', statusLabel:'26/03 · Miami Open · WTA SF',       competition:'WTA Miami 2026 · SF',   title:'Sabalenka × Gauff',           subtitle:'Duelo das duas melhores do mundo WTA', bettvPick:'Sabalenka',   bettvConf:58, bettvReason:'Sabalenka Nº1 WTA, campeã Miami 2025. Gauff Nº3, forte em Miami mas H2H desfavorável (2V-5D).',     home:{name:'A. Sabalenka', sub:'Nº1 WTA',    pct:57}, away:{name:'C. Gauff',     sub:'Nº3 WTA',    pct:32}, draw:11 },
  ]},
  esports: { label:'E-sports', items:[
    // CBLOL 2026 Etapa 1 — começa 28/03
    { id:'e1',  status:'upcoming', startTime:'2026-03-28T13:00:00-03:00', statusLabel:'28/03 · Riot Arena · 13h',          competition:'CBLOL 2026 · Etapa 1 · Rd 1',title:'LOUD × paiN Gaming',  subtitle:'Campeã estreia na Etapa 1',              bettvPick:'LOUD',        bettvConf:66, bettvReason:'LOUD campeã Copa CBLOL 2026 com Bull e RedBert dominantes. paiN Gaming sem título desde 2023.',     home:{name:'LOUD',         sub:'Campeã Copa', pct:62}, away:{name:'paiN Gaming',   sub:'4º Copa',    pct:24}, draw:14 },
    { id:'e2',  status:'upcoming', startTime:'2026-03-28T15:00:00-03:00', statusLabel:'28/03 · Riot Arena · 15h',          competition:'CBLOL 2026 · Etapa 1 · Rd 1',title:'FURIA × RED Canids', subtitle:'Bootcamp Korea vs consistência RED',     bettvPick:'FURIA',       bettvConf:54, bettvReason:'FURIA bootcampou na Coreia pré-temporada. RED Canids inconstante mas Grevthar é diferencial.',       home:{name:'FURIA',        sub:'Americas Cup',pct:52}, away:{name:'RED Canids',    sub:'5º Copa',    pct:32}, draw:16 },
    { id:'e3',  status:'upcoming', startTime:'2026-04-04T13:00:00-03:00', statusLabel:'04/04 · Riot Arena · 13h',          competition:'CBLOL 2026 · Etapa 1 · Rd 2',title:'LOUD × FURIA',      subtitle:'O maior clássico do LoL nacional',       bettvPick:'LOUD',        bettvConf:55, bettvReason:'LOUD lidera o H2H histórico vs FURIA (12V-8D). FURIA com motivação pós-bootcamp na Coreia.',        home:{name:'LOUD',         sub:'Campeã Copa', pct:53}, away:{name:'FURIA',          sub:'Americas Cup',pct:35}, draw:12 },
    // LCK Coreia — T1 vs Gen.G (mais importante do mundo)
    { id:'e4',  status:'upcoming', startTime:'2026-04-05T17:00:00+09:00', statusLabel:'05/04 · 05h · LCK · Seoul',         competition:'LCK Spring 2026 · Playoffs',title:'T1 × Gen.G',       subtitle:'Semifinal LCK — Faker vs Chovy',        bettvPick:'T1',          bettvConf:58, bettvReason:'T1 e Faker são históricos nos playoffs da LCK. Gen.G tem Chovy mas T1 tem mais experiência em finais.',home:{name:'T1',           sub:'1º LCK',     pct:56}, away:{name:'Gen.G',          sub:'2º LCK',     pct:32}, draw:12 },
    // Valorant Champions Tour
    { id:'e5',  status:'upcoming', startTime:'2026-04-10T18:00:00+02:00', statusLabel:'10/04 · 13h · VCT Madrid',          competition:'VCT EMEA 2026 · Masters',  title:'Fnatic × Team Vitality',   subtitle:'Clash Europeu no VCT Madrid',           bettvPick:'Fnatic',      bettvConf:52, bettvReason:'Fnatic dono do VCT EMEA historicamente. Vitality com roster renovado e erros na comunicação.',       home:{name:'Fnatic',       sub:'EMEA · ING', pct:51}, away:{name:'Team Vitality',  sub:'EMEA · FRA', pct:33}, draw:16 },
    // CS2 Major
    { id:'e6',  status:'upcoming', startTime:'2026-05-01T14:00:00+02:00', statusLabel:'01/05 · 09h · CS2 Major 2026',      competition:'CS2 Major 2026 · Quarterfinal',title:'Natus Vincere × FAZE Clan',subtitle:'Clássico histórico do CS2',          bettvPick:'NaVi',        bettvConf:53, bettvReason:'NaVi com s1mple retornado ao melhor nível. FaZe forte mas NaVi tem mais títulos em Majors (3).',      home:{name:'Natus Vincere',sub:'Top 5 CS2',  pct:52}, away:{name:'FaZe Clan',      sub:'Top 5 CS2',  pct:35}, draw:13 },
  ]},
}
