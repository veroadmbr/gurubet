...
const ESPORTES = {
  ...
  basquete: { label:'Basquete', items:[
    // NBA Hoje 23/03 — dados reais SportRadar
    { id:'b-phi-okc', startTime:'2026-03-23T23:00:00Z', statusLabel:'Hoje · 20h BRT · Wells Fargo Center',  competition:'NBA · Temp. Regular', title:'Philadelphia 76ers × OKC Thunder',       bettvPick:'OKC Thunder',          bettvConf:90, bettvReason:'OKC 56-15 (.789) 1º Oeste. SGA candidato MVP. 76ers 39-32 sem consistência.', home:{name:'Philadelphia 76ers',   logo:'sixers',   sub:'8º Leste · 39-32', pct:10}, away:{name:'OKC Thunder',          logo:'okc',      sub:'1º Oeste · 56-15', pct:90}, draw:0 },
    { id:'b-det-lal', startTime:'2026-03-23T23:00:00Z', statusLabel:'Hoje · 20h BRT · Little Caesars Arena', competition:'NBA · Temp. Regular', title:'Detroit Pistons × LA Lakers',            bettvPick:'LA Lakers',            bettvConf:54, bettvReason:'Lakers 46-25 em forma. Pistons 51-19 1º Leste, duelo equilibrado. LeBron × Cade.', home:{name:'Detroit Pistons',      logo:null,       sub:'1º Leste · 51-19', pct:46}, away:{name:'LA Lakers',            logo:'lakers',   sub:'3º Oeste · 46-25', pct:54}, draw:0 },
    { id:'b-mia-sas', startTime:'2026-03-23T23:00:00Z', statusLabel:'Hoje · 20h BRT · Kaseya Center',       competition:'NBA · Temp. Regular', title:'Miami Heat × San Antonio Spurs',         bettvPick:'San Antonio Spurs',    bettvConf:65, bettvReason:'Spurs 53-18 2º Oeste. Wembanyama dominante. Heat 38-33 brigando por playoffs.', home:{name:'Miami Heat',           logo:'heat',     sub:'7º Leste · 38-33', pct:35}, away:{name:'San Antonio Spurs',    logo:'spurs',    sub:'2º Oeste · 53-18', pct:65}, draw:0 },
    { id:'b-orl-ind', startTime:'2026-03-23T23:00:00Z', statusLabel:'Hoje · 20h BRT · Kia Center',          competition:'NBA · Temp. Regular', title:'Orlando Magic × Indiana Pacers',         bettvPick:'Orlando Magic',        bettvConf:87, bettvReason:'Magic 38-32 favorito em casa. Pacers 15-56 pior campanha do Leste.', home:{name:'Orlando Magic',        logo:'magic',    sub:'6º Leste · 38-32', pct:87}, away:{name:'Indiana Pacers',       logo:'pacers',   sub:'15º Leste · 15-56',pct:13}, draw:0 },
    { id:'b-atl-mem', startTime:'2026-03-23T23:30:00Z', statusLabel:'Hoje · 20h30 BRT · State Farm Arena',   competition:'NBA · Temp. Regular', title:'Atlanta Hawks × Memphis Grizzlies',      bettvPick:'Atlanta Hawks',        bettvConf:89, bettvReason:'Hawks 39-32 em casa sólidos. Grizzlies 24-46 em reconstrução.', home:{name:'Atlanta Hawks',        logo:'hawks',    sub:'5º Leste · 39-32', pct:89}, away:{name:'Memphis Grizzlies',    logo:'grizzlies',sub:'13º Oeste · 24-46',pct:11}, draw:0 },
    { id:'b-chi-hou', startTime:'2026-03-24T00:00:00Z', statusLabel:'Hoje · 21h BRT · United Center',       competition:'NBA · Temp. Regular', title:'Chicago Bulls × Houston Rockets',        bettvPick:'Houston Rockets',      bettvConf:76, bettvReason:'Rockets 43-27 6º Oeste forte. Bulls 28-42 sem expectativa de playoffs.', home:{name:'Chicago Bulls',        logo:null,       sub:'12º Leste · 28-42',pct:24}, away:{name:'Houston Rockets',      logo:'rockets',  sub:'6º Oeste · 43-27', pct:76}, draw:0 },
    { id:'b-uta-tor', startTime:'2026-03-24T01:00:00Z', statusLabel:'Hoje · 22h BRT · Delta Center',        competition:'NBA · Temp. Regular', title:'Utah Jazz × Toronto Raptors',            bettvPick:'Toronto Raptors',      bettvConf:86, bettvReason:'Raptors 39-31 ressurgimento. Jazz 21-50 em tanking total.', home:{name:'Utah Jazz',            logo:'jazz',     sub:'14º Oeste · 21-50',pct:14}, away:{name:'Toronto Raptors',      logo:'raptors',  sub:'9º Leste · 39-31', pct:86}, draw:0 },
    { id:'b-dal-gsw', startTime:'2026-03-24T01:30:00Z', statusLabel:'Hoje · 22h30 BRT · Am. Airlines Ctr',  competition:'NBA · Temp. Regular', title:'Dallas Mavericks × Golden State Warriors',bettvPick:'Golden State Warriors',bettvConf:54, bettvReason:'Warriors 33-38 Curry em forma. Mavs 23-48 pós-troca de Doncic.', home:{name:'Dallas Mavericks',     logo:'mavericks',sub:'15º Oeste · 23-48',pct:46}, away:{name:'Golden State Warriors',logo:'warriors', sub:'11º Oeste · 33-38',pct:54}, draw:0 },
    { id:'b-por-bkn', startTime:'2026-03-24T02:00:00Z', statusLabel:'Hoje · 23h BRT · Moda Center',         competition:'NBA · Temp. Regular', title:'Portland Trail Blazers × Brooklyn Nets', bettvPick:'Portland Trail Blazers',bettvConf:89, bettvReason:'Blazers 35-37 em casa fortes. Nets 17-54 pior campanha Leste com Wizards.', home:{name:'Portland Trail Blazers',logo:'blazers',  sub:'10º Oeste · 35-37',pct:89}, away:{name:'Brooklyn Nets',        logo:'nets',     sub:'14º Leste · 17-54',pct:11}, draw:0 },
    { id:'b-lac-mil', startTime:'2026-03-24T02:30:00Z', statusLabel:'Hoje · 23h30 BRT · Intuit Dome',       competition:'NBA · Temp. Regular', title:'LA Clippers × Milwaukee Bucks',          bettvPick:'LA Clippers',          bettvConf:87, bettvReason:'Clippers 35-36 em casa no Intuit Dome. Bucks 29-41 temporada perdida.', home:{name:'LA Clippers',          logo:'clippers', sub:'9º Oeste · 35-36', pct:87}, away:{name:'Milwaukee Bucks',      logo:'bucks',    sub:'11º Leste · 29-41',pct:13}, draw:0 },
    // NBA amanhã 24/03
    { id:'b-cha-sac', startTime:'2026-03-24T23:00:00Z', statusLabel:'Amanhã · 20h BRT · Spectrum Center',   competition:'NBA · Temp. Regular', title:'Charlotte Hornets × Sacramento Kings',   bettvPick:'Charlotte Hornets',    bettvConf:65, bettvReason:'Hornets 37-34 em casa. Kings 19-53 uma das piores campanhas do Oeste.', home:{name:'Charlotte Hornets',    logo:'hornets',  sub:'10º Leste · 37-34',pct:65}, away:{name:'Sacramento Kings',     logo:'kings',    sub:'14º Oeste · 19-53',pct:35}, draw:0 },
    { id:'b-nyk-nop', startTime:'2026-03-24T23:30:00Z', statusLabel:'Amanhã · 20h30 BRT · MSG',             competition:'NBA · Temp. Regular', title:'New York Knicks × New Orleans Pelicans',  bettvPick:'New York Knicks',      bettvConf:78, bettvReason:'Knicks 47-25 3º Leste em casa no MSG. Pelicans 25-47 fora de playoffs.', home:{name:'New York Knicks',      logo:'knicks',   sub:'3º Leste · 47-25', pct:78}, away:{name:'New Orleans Pelicans', logo:'pelicans', sub:'12º Oeste · 25-47',pct:22}, draw:0 },
  ]},
  ...
  mma: { label:'MMA / UFC', items:[
    ...
    { id:'m-ade',  startTime:'2026-03-29T01:40:00Z', statusLabel:'28/03 · 22h40 BRT · Climate Pledge · Seattle', competition:'UFC FN 271 · Main Event',  title:'Adesanya × Pyfer',          bettvPick:'Adesanya', bettvConf:62, bettvReason:'Adesanya Nº4 MW (24-5). Pyfer Nº14 (15-3) resistente mas Izzy tem alcance e técnica superiores.', home:{name:'I. Adesanya',  logo:'adesanya',  sub:'Nº4 MW · 24-5',  pct:60}, away:{name:'J. Pyfer',      logo:null,sub:'Nº14 MW · 15-3',pct:30}, draw:10},
    { id:'m-gra',  startTime:'2026-03-29T01:20:00Z', statusLabel:'28/03 · 22h20 BRT · Co-main · Seattle',          competition:'UFC FN 271 · Co-main',     title:'Grasso × Barber',           bettvPick:'Grasso',   bettvConf:58, bettvReason:'Alexa Grasso ex-campeã FLW. Maycee Barber em ascensão. Grasso mais técnica no chão.', home:{name:'A. Grasso',    logo:null,sub:'Ex-camp FLY',     pct:56}, away:{name:'M. Barber',     logo:null,sub:'FLY contender',  pct:34}, draw:10},
    { id:'m-hoo',  startTime:'2026-03-28T22:40:00Z', statusLabel:'28/03 · 19h40 BRT · Card Principal · Seattle',   competition:'UFC FN 271 · Card Princ.', title:'Hooper × Gibson Jr',        bettvPick:'Hooper',   bettvConf:65, bettvReason:'Chase Hooper mais experiente e técnico. Gibson Jr estreante. Decisão provável.', home:{name:'C. Hooper',    logo:null,sub:'LW · UFC',        pct:65}, away:{name:'L. Gibson Jr',  logo:null,sub:'LW · estreante',pct:25}, draw:10},
  ...
  tenis: { label:'Tênis', items:[
    // Miami Open AO VIVO hoje (23/03) — dados reais Sportradar
    { id:'t-hum', startTime:'2026-03-23T15:00:00Z', statusLabel:'AO VIVO · Miami Open R64 · ATP',   competition:'ATP Miami Open · R64', title:'Shevchenko × Humbert',       bettvPick:'Humbert',  bettvConf:62, bettvReason:'Ugo Humbert top 20 ATP. Shevchenko qualifier. Humbert mais consistente.', home:{name:'A. Shevchenko', logo:null,sub:'ATP Qualifier', pct:30}, away:{name:'U. Humbert',   logo:null,sub:'Top 20 ATP',  pct:62}, draw:8 },
    { id:'t-muc', startTime:'2026-03-23T15:00:00Z', statusLabel:'AO VIVO · Miami Open R64 · WTA',   competition:'WTA Miami Open · R64', title:'Muchova × Eala',             bettvPick:'Muchova',  bettvConf:78, bettvReason:'Muchova top 10 WTA. Eala em ascensão mas diferença técnica grande.', home:{name:'K. Muchova',    logo:null,sub:'Top 10 WTA',  pct:78}, away:{name:'A. Eala',      logo:null,sub:'WTA Rising',  pct:15}, draw:7 },
    { id:'t-med', startTime:'2026-03-23T16:00:00Z', statusLabel:'Hoje · 13h BRT · Miami R64 ATP',   competition:'ATP Miami Open · R64', title:'Cerundolo × Medvedev',       bettvPick:'Medvedev', bettvConf:72, bettvReason:'Daniil Medvedev ex-Nº1. Cerundolo top 30 mas Medvedev domina hard court.', home:{name:'F. Cerundolo',  logo:null,sub:'Top 30 ATP',  pct:22}, away:{name:'D. Medvedev',  logo:'medvedev',sub:'Top 5 ATP',pct:72}, draw:6 },
    { id:'t-and', startTime:'2026-03-23T16:10:00Z', statusLabel:'Hoje · 13h10 BRT · Miami R64 WTA', competition:'WTA Miami Open · R64', title:'Andreeva × Mboko',           bettvPick:'Andreeva', bettvConf:82, bettvReason:'Mirra Andreeva prodígio top 20 WTA com 17 anos. Mboko qualifier.', home:{name:'M. Andreeva',   logo:null,sub:'Top 20 WTA',  pct:82}, away:{name:'V. Mboko',     logo:null,sub:'WTA Qualifier',pct:12}, draw:6 },
...
function mergeSport(current, updates, now) {
  ...
  // MERGE: update existing + add new, keep items not in update set
  const newIds = new Set(valid.map(i => i.id))
  const kept = safeCurrents.filter(i => !newIds.has(i.id) && new Date(i.startTime).getTime() > now - 4*60*60*1000)
...
function useAutoUpdate(seed) {
  ...
  const force = useCallback(() => {
    if (cycleRef.current) {
      // Safety: if stuck >5min, force-reset
      if (Date.now() - (cycleRef._ts||0) > 5*60*1000) { cycleRef.current = false; setUpdating(false) }
      else return
    }
    cycleRef._ts = Date.now()
