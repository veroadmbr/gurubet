...
// ─── CRYPTO DATA ─────────────────────────────────────────────────────────────
const CRYPTO_DATA = [
  {id:'btc', symbol:'BTC', name:'Bitcoin',           price:87420,  change24h:+2.3, bettvPick:'ALTA',   bettvConf:67, bettvReason:'Dominância 54%. ETFs acumulando. Resistência $90k próxima.', logo:'https://cryptologos.cc/logos/bitcoin-btc-logo.png',yearPick:'ALTA',yearConf:72,yearReason:'Halving 2024 + ETFs. Ciclo histórico aponta $120k–$150k até dez/2026.'},
  {id:'eth', symbol:'ETH', name:'Ethereum',           price:2015,   change24h:-0.8, bettvPick:'NEUTRO', bettvConf:45, bettvReason:'Luta com resistência $2100. Dencun ativo mas demanda fraca.', logo:'https://cryptologos.cc/logos/ethereum-eth-logo.png',yearPick:'ALTA',yearConf:60,yearReason:'Staking e L2s crescendo. Meta $4k–$6k em 2026 pós-Pectra upgrade.'},
  {id:'sol', symbol:'SOL', name:'Solana',             price:142.5,  change24h:+4.1, bettvPick:'ALTA',   bettvConf:62, bettvReason:'Ganha market share em DEX. Volume Raydium recorde semanal.', logo:'https://cryptologos.cc/logos/solana-sol-logo.png',yearPick:'ALTA',yearConf:65,yearReason:'DeFi líder em volume. Projeção $300–$500 com adoção crescente.'},
  {id:'bnb', symbol:'BNB', name:'BNB',                price:598,    change24h:+1.2, bettvPick:'ALTA',   bettvConf:55, bettvReason:'BNB Chain TVL cresce 8% na semana. Queima trimestral positiva.', logo:'https://cryptologos.cc/logos/bnb-bnb-logo.png',yearPick:'ALTA',yearConf:58,yearReason:'BNB Chain queima deflacionária. Faixa alvo $800–$1.200 em 2026.'},
  {id:'xrp', symbol:'XRP', name:'XRP',                price:0.524,  change24h:-1.4, bettvPick:'QUEDA',  bettvConf:52, bettvReason:'Perde momentum após alta de 40% em fevereiro. Correção provável.', logo:'https://cryptologos.cc/logos/xrp-xrp-logo.png',yearPick:'ALTA',yearConf:55,yearReason:'Caso SEC encerrado. Pagamentos institucionais. Meta $1.50–$3.'},
  {id:'usdc',symbol:'USDC',name:'USD Coin',           price:1.00,   change24h:0.0,  bettvPick:'NEUTRO', bettvConf:99, bettvReason:'Stablecoin atrelada ao dólar. Sem variação esperada.', logo:'https://cryptologos.cc/logos/usd-coin-usdc-logo.png',yearPick:'NEUTRO',yearConf:99,yearReason:'Stablecoin USD. Sem variação prevista em 2026.'},
  {id:'ada', symbol:'ADA', name:'Cardano',            price:0.387,  change24h:+1.8, bettvPick:'ALTA',   bettvConf:48, bettvReason:'Chang 2 ativado. Staking crescendo.', logo:'https://cryptologos.cc/logos/cardano-ada-logo.png',yearPick:'ALTA',yearConf:48,yearReason:'Chang 2 ativo. Ecossistema DeFi nascente. Meta $0.80–$1.50.'},
  {id:'avax',symbol:'AVAX',name:'Avalanche',          price:24.8,   change24h:+2.9, bettvPick:'ALTA',   bettvConf:57, bettvReason:'Subnet Teleporter ganha adoção. TVL em recuperação.', logo:'https://cryptologos.cc/logos/avalanche-avax-logo.png',yearPick:'ALTA',yearConf:55,yearReason:'Subnets empresariais. Projeção $60–$100 com bull market.'},
  {id:'doge',symbol:'DOGE',name:'Dogecoin',           price:0.178,  change24h:+5.2, bettvPick:'ALTA',   bettvConf:43, bettvReason:'Alta especulativa com buzz Musk/Tesla.', logo:'https://cryptologos.cc/logos/dogecoin-doge-logo.png',yearPick:'ALTA',yearConf:42,yearReason:'Narrativa meme+Musk. Volátil. Meta especulativa $0.50–$1.'},
  {id:'dot', symbol:'DOT', name:'Polkadot',           price:5.82,   change24h:-0.5, bettvPick:'NEUTRO', bettvConf:44, bettvReason:'Polkadot 2.0 em implementação. Consolidação lateral.', logo:'https://cryptologos.cc/logos/polkadot-new-dot-logo.png',yearPick:'ALTA',yearConf:46,yearReason:'Polkadot 2.0 entregue. JAM protocol. Meta $15–$25.'},
  {id:'link',symbol:'LINK',name:'Chainlink',          price:14.2,   change24h:+3.1, bettvPick:'ALTA',   bettvConf:59, bettvReason:'CCIP adotado por grandes bancos. Oráculos em alta demanda.', logo:'https://cryptologos.cc/logos/chainlink-link-logo.png',yearPick:'ALTA',yearConf:62,yearReason:'Oráculos indispensáveis. CCIP bancário. Meta $30–$50.'},
  {id:'matic',symbol:'POL',name:'Polygon',            price:0.392,  change24h:-2.1, bettvPick:'QUEDA',  bettvConf:53, bettvReason:'Migração POL completa mas L2 perdendo para ARB.', logo:'https://cryptologos.cc/logos/polygon-matic-logo.png',yearPick:'QUEDA',yearConf:45,yearReason:'POL migração concluída mas L2 perde market share para ARB.'},
  {id:'uni', symbol:'UNI', name:'Uniswap',            price:8.74,   change24h:+1.5, bettvPick:'ALTA',   bettvConf:50, bettvReason:'Uniswap v4 no ar. Volume DEX recorde.', logo:'https://cryptologos.cc/logos/uniswap-uni-logo.png',yearPick:'ALTA',yearConf:52,yearReason:'Uniswap v4 + fee switch. Meta $20–$35 com DeFi bull.'},
  {id:'near',symbol:'NEAR',name:'NEAR Protocol',      price:3.21,   change24h:+6.8, bettvPick:'ALTA',   bettvConf:61, bettvReason:'AI integrations ganhando tração. Sharding fase 3 entregue.', logo:'https://cryptologos.cc/logos/near-protocol-near-logo.png',yearPick:'ALTA',yearConf:58,yearReason:'AI+blockchain líder. Sharding fase 3. Meta $10–$18.'},
  {id:'arb', symbol:'ARB', name:'Arbitrum',           price:0.481,  change24h:+2.4, bettvPick:'ALTA',   bettvConf:55, bettvReason:'Lidera L2 em TVL ($18B). Stylus VM atrai devs.', logo:'https://cryptologos.cc/logos/arbitrum-arb-logo.png',yearPick:'ALTA',yearConf:57,yearReason:'Líder L2 em TVL. Stylus VM. Meta $1.50–$2.50.'},
  {id:'op',  symbol:'OP',  name:'Optimism',           price:1.02,   change24h:+1.8, bettvPick:'ALTA',   bettvConf:51, bettvReason:'Superchain crescendo. Base usa OP Stack.', logo:'https://cryptologos.cc/logos/optimism-ethereum-op-logo.png',yearPick:'ALTA',yearConf:52,yearReason:'Superchain crescendo. Meta $3–$5 com adoção Base+OP.'},
  {id:'sui', symbol:'SUI', name:'Sui',                price:2.84,   change24h:+7.3, bettvPick:'ALTA',   bettvConf:65, bettvReason:'Maior ganhador da semana. TVL DeFi triplica em 30 dias.', logo:'https://cryptologos.cc/logos/sui-sui-logo.png',yearPick:'ALTA',yearConf:63,yearReason:'Melhor L1 2026. TVL 3x. Meta $8–$15 até dezembro.'},
  {id:'ton', symbol:'TON', name:'Toncoin',            price:3.74,   change24h:+2.1, bettvPick:'ALTA',   bettvConf:60, bettvReason:'Integração Telegram 900M usuários. Mini-apps em explosão.', logo:'https://cryptologos.cc/logos/toncoin-ton-logo.png',yearPick:'ALTA',yearConf:62,yearReason:'900M Telegram users. Mini-apps. Meta $10–$18.'},
  {id:'apt', symbol:'APT', name:'Aptos',              price:5.67,   change24h:+3.2, bettvPick:'ALTA',   bettvConf:54, bettvReason:'DeFi TVL em máxima histórica. Integração Google Cloud.', logo:'https://cryptologos.cc/logos/aptos-apt-logo.png',yearPick:'ALTA',yearConf:56,yearReason:'Aptos DeFi máxima. Google Cloud. Meta $15–$25.'},
  {id:'tia', symbol:'TIA', name:'Celestia',           price:3.87,   change24h:+5.1, bettvPick:'ALTA',   bettvConf:58, bettvReason:'Modular blockchain em alta adoção. Rollups migrando.', logo:'https://cryptologos.cc/logos/celestia-tia-logo.png',yearPick:'ALTA',yearConf:58,yearReason:'Modular blockchain liderança. Meta $12–$20.'},
  {id:'sei', symbol:'SEI', name:'Sei',                price:0.247,  change24h:+8.2, bettvPick:'ALTA',   bettvConf:62, bettvReason:'SEI v2 paralelização. L1 mais rápido para trading.', logo:'https://cryptologos.cc/logos/sei-sei-logo.png',yearPick:'ALTA',yearConf:60,yearReason:'L1 de trading mais rápido. Meta $0.80–$1.50.'},
  {id:'inj', symbol:'INJ', name:'Injective',          price:18.4,   change24h:+4.5, bettvPick:'ALTA',   bettvConf:59, bettvReason:'Lidera DeFi em trading perpétuo. Cosmos integrado.', logo:'https://cryptologos.cc/logos/injective-inj-logo.png',yearPick:'ALTA',yearConf:57,yearReason:'Perp DeFi líder. Cosmos. Meta $45–$70.'},
  {id:'rndr',symbol:'RNDR',name:'Render',             price:4.92,   change24h:+5.7, bettvPick:'ALTA',   bettvConf:60, bettvReason:'GPU computing para IA em boom. Parceria Nvidia.', logo:'https://cryptologos.cc/logos/render-token-rndr-logo.png',yearPick:'ALTA',yearConf:62,yearReason:'GPU AI computing boom. Nvidia parceiro. Meta $12–$20.'},
  {id:'fet', symbol:'FET', name:'Fetch.ai',           price:1.13,   change24h:+9.1, bettvPick:'ALTA',   bettvConf:63, bettvReason:'Narrativa AI+crypto forte. ASI Alliance em expansão.', logo:'https://cryptologos.cc/logos/fetch-ai-fet-logo.png',yearPick:'ALTA',yearConf:65,yearReason:'ASI Alliance+AI narrativa. Meta $3–$6.'},
  {id:'jup', symbol:'JUP', name:'Jupiter',            price:0.582,  change24h:+4.3, bettvPick:'ALTA',   bettvConf:57, bettvReason:'Maior DEX aggregator da Solana. Volume $1B/dia.', logo:'https://cryptologos.cc/logos/jupiter-jup-logo.png',yearPick:'ALTA',yearConf:55,yearReason:'DEX aggregator Sol. Meta $1.50–$3.'},
  {id:'aave',symbol:'AAVE',name:'Aave',               price:162,    change24h:+2.5, bettvPick:'ALTA',   bettvConf:58, bettvReason:'$15B TVL líder DeFi lending. GHO stablecoin crescendo.', logo:'https://cryptologos.cc/logos/aave-aave-logo.png',yearPick:'ALTA',yearConf:58,yearReason:'DeFi lending líder. GHO crescendo. Meta $400–$600.'},
  {id:'mkr', symbol:'MKR', name:'MakerDAO',           price:1240,   change24h:+1.9, bettvPick:'ALTA',   bettvConf:52, bettvReason:'DAI $8B circulação. Sky Protocol expansão ativa.', logo:'https://cryptologos.cc/logos/maker-mkr-logo.png',yearPick:'ALTA',yearConf:52,yearReason:'DAI+Sky Protocol. Meta $2.500–$4.000.'},
  {id:'stx', symbol:'STX', name:'Stacks',             price:0.847,  change24h:+3.6, bettvPick:'ALTA',   bettvConf:56, bettvReason:'Bitcoin DeFi ganha tração. sBTC lançado.', logo:'https://cryptologos.cc/logos/stacks-stx-logo.png',yearPick:'ALTA',yearConf:54,yearReason:'Bitcoin DeFi. sBTC. Meta $2–$4.'},
  {id:'kas', symbol:'KAS', name:'Kaspa',              price:0.082,  change24h:+4.2, bettvPick:'ALTA',   bettvConf:55, bettvReason:'PoW mais rápido do mundo. Mineradores migrando do ETC.', logo:'https://cryptologos.cc/logos/kaspa-kas-logo.png',yearPick:'ALTA',yearConf:53,yearReason:'PoW mais rápido. Mineradores migrando. Meta $0.20–$0.40.'},
  {id:'blur',symbol:'BLUR',name:'Blur',               price:0.148,  change24h:+6.1, bettvPick:'ALTA',   bettvConf:49, bettvReason:'Marketplace NFT recupera volume. Airdrop no horizonte.', logo:'https://cryptologos.cc/logos/blur-blur-logo.png',yearPick:'ALTA',yearConf:45,yearReason:'NFT marketplace em recuperação. Airdrop. Meta $0.40–$0.80.'},
  {id:'wld', symbol:'WLD', name:'Worldcoin',          price:1.42,   change24h:-3.1, bettvPick:'QUEDA',  bettvConf:54, bettvReason:'Preocupações regulatórias na Europa. Pressão de insiders.', logo:'https://cryptologos.cc/logos/worldcoin-wld-logo.png',yearPick:'QUEDA',yearConf:52,yearReason:'Risco regulatório Europa. Pressão vendas insiders. Meta $1–$2.'},
  {id:'atom',symbol:'ATOM',name:'Cosmos',             price:4.12,   change24h:-1.0, bettvPick:'NEUTRO', bettvConf:42, bettvReason:'IBC crescendo mas inflacionário. Sem catalisador.', logo:'https://cryptologos.cc/logos/cosmos-atom-logo.png',yearPick:'NEUTRO',yearConf:43,yearReason:'IBC crescendo mas inflação alta. Lateral em $4–$8.'},
  {id:'ltc', symbol:'LTC', name:'Litecoin',           price:76.3,   change24h:+0.9, bettvPick:'NEUTRO', bettvConf:41, bettvReason:'Segue BTC. Halving 2027 no radar.', logo:'https://cryptologos.cc/logos/litecoin-ltc-logo.png',yearPick:'ALTA',yearConf:46,yearReason:'Halving 2027 no radar. Segue BTC. Meta $120–$200.'},
  {id:'fil', symbol:'FIL', name:'Filecoin',           price:3.15,   change24h:-1.2, bettvPick:'NEUTRO', bettvConf:43, bettvReason:'Armazenamento descentralizado sem catalisador. Lateral.', logo:'https://cryptologos.cc/logos/filecoin-fil-logo.png',yearPick:'NEUTRO',yearConf:42,yearReason:'Armazenamento descentralizado sem catalisador. Lateral $3–$6.'},
  {id:'grt', symbol:'GRT', name:'The Graph',          price:0.134,  change24h:+3.4, bettvPick:'ALTA',   bettvConf:52, bettvReason:'Infraestrutura web3 crescendo com DeFi bull.', logo:'https://cryptologos.cc/logos/the-graph-grt-logo.png',yearPick:'ALTA',yearConf:50,yearReason:'Infraestrutura web3. Meta $0.35–$0.60.'},
  {id:'icp', symbol:'ICP', name:'Internet Computer',  price:8.24,   change24h:+2.0, bettvPick:'ALTA',   bettvConf:48, bettvReason:'Computação on-chain. Novos dApps lançados.', logo:'https://cryptologos.cc/logos/internet-computer-icp-logo.png',yearPick:'ALTA',yearConf:47,yearReason:'Computação on-chain. Novos dApps. Meta $15–$30.'},
  {id:'hbar',symbol:'HBAR',name:'Hedera',             price:0.063,  change24h:+1.4, bettvPick:'ALTA',   bettvConf:47, bettvReason:'Governança enterprise IBM/Google. Tokenização RWA.', logo:'https://cryptologos.cc/logos/hedera-hbar-logo.png',yearPick:'ALTA',yearConf:48,yearReason:'RWA tokenização enterprise. Meta $0.15–$0.30.'},
  {id:'egld',symbol:'EGLD',name:'MultiversX',         price:27.4,   change24h:+2.8, bettvPick:'ALTA',   bettvConf:50, bettvReason:'DeFi crescendo. xPortal app com 2M usuários.', logo:'https://cryptologos.cc/logos/elrond-egld-logo.png',yearPick:'ALTA',yearConf:50,yearReason:'MultiversX DeFi. xPortal 2M users. Meta $60–$100.'},
  {id:'algo',symbol:'ALGO',name:'Algorand',           price:0.162,  change24h:-0.8, bettvPick:'NEUTRO', bettvConf:39, bettvReason:'Sem catalisador. Parcerias governamentais não movem preço.', logo:'https://cryptologos.cc/logos/algorand-algo-logo.png',yearPick:'NEUTRO',yearConf:40,yearReason:'Sem catalisador. Parcerias gov. Lateral $0.15–$0.30.'},
  {id:'sand',symbol:'SAND',name:'The Sandbox',        price:0.287,  change24h:+1.1, bettvPick:'NEUTRO', bettvConf:38, bettvReason:'Metaverse perdeu hype. Gaming parceria aquece levemente.', logo:'https://cryptologos.cc/logos/the-sandbox-sand-logo.png',yearPick:'NEUTRO',yearConf:39,yearReason:'Metaverse hype baixo. Gaming parcerias. Lateral $0.30–$0.60.'},
  {id:'xlm', symbol:'XLM', name:'Stellar',            price:0.094,  change24h:+1.7, bettvPick:'NEUTRO', bettvConf:42, bettvReason:'Pagamentos internacionais estáveis. Sem catalisador.', logo:'https://cryptologos.cc/logos/stellar-xlm-logo.png',yearPick:'NEUTRO',yearConf:43,yearReason:'Pagamentos estáveis. Sem catalisador. $0.10–$0.20.'},
  {id:'crv', symbol:'CRV', name:'Curve',              price:0.342,  change24h:-0.7, bettvPick:'NEUTRO', bettvConf:44, bettvReason:'TVL estável $2.1B. Governança afasta especuladores.', logo:'https://cryptologos.cc/logos/curve-dao-token-crv-logo.png',yearPick:'NEUTRO',yearConf:44,yearReason:'TVL estável. Governança complexa. Lateral $0.30–$0.60.'},
  {id:'w',   symbol:'W',   name:'Wormhole',           price:0.192,  change24h:+3.8, bettvPick:'ALTA',   bettvConf:51, bettvReason:'Bridge: $50B+ volume. Adoção cross-chain crescendo.', logo:'https://cryptologos.cc/logos/wormhole-w-logo.png',yearPick:'ALTA',yearConf:50,yearReason:'Bridge cross-chain essencial. Meta $0.40–$0.80.'},
  {id:'zk',  symbol:'ZK',  name:'ZKsync',             price:0.094,  change24h:-1.5, bettvPick:'NEUTRO', bettvConf:45, bettvReason:'L2 promissor mas concorrência com Starknet.', logo:'https://cryptologos.cc/logos/zksync-zk-logo.png',yearPick:'ALTA',yearConf:46,yearReason:'L2 ZK promissor. Concorrência Starknet. Meta $0.20–$0.40.'},
  {id:'bch', symbol:'BCH', name:'Bitcoin Cash',       price:336,    change24h:+1.4, bettvPick:'ALTA',   bettvConf:48, bettvReason:'Segue BTC. Momentum pós-halving ainda presente.', logo:'https://cryptologos.cc/logos/bitcoin-cash-bch-logo.png',yearPick:'ALTA',yearConf:46,yearReason:'Segue BTC pós-halving. Meta $500–$800.'},
  {id:'etc', symbol:'ETC', name:'Ethereum Classic',   price:18.6,   change24h:-0.3, bettvPick:'NEUTRO', bettvConf:38, bettvReason:'Estável. Movimentos seguem ETH.', logo:'https://cryptologos.cc/logos/ethereum-classic-etc-logo.png',yearPick:'NEUTRO',yearConf:39,yearReason:'Segue ETH lateral. Sem catalisador. $20–$35.'},
  {id:'pyth',symbol:'PYTH',name:'Pyth Network',       price:0.312,  change24h:+2.7, bettvPick:'ALTA',   bettvConf:53, bettvReason:'Oráculo líder Solana. 200+ novos feeds adicionados.', logo:'https://cryptologos.cc/logos/pyth-network-pyth-logo.png',yearPick:'ALTA',yearConf:52,yearReason:'Oráculos Sol. 200+ feeds. Meta $0.70–$1.20.'},
  {id:'snx', symbol:'SNX', name:'Synthetix',          price:1.28,   change24h:+1.3, bettvPick:'NEUTRO', bettvConf:42, bettvReason:'Perp trading v3 no ar mas concorrência com GMX.', logo:'https://cryptologos.cc/logos/synthetix-network-token-snx-logo.png',yearPick:'NEUTRO',yearConf:43,yearReason:'Perp v3 ativo. Concorrência GMX. Lateral $1.50–$3.'},
  {id:'vet', symbol:'VET', name:'VeChain',            price:0.028,  change24h:+0.5, bettvPick:'NEUTRO', bettvConf:40, bettvReason:'Supply chain blockchain com adoção empresarial.', logo:'https://cryptologos.cc/logos/vechain-vet-logo.png',yearPick:'NEUTRO',yearConf:41,yearReason:'Supply chain estável. Sem catalisador. $0.04–$0.08.'},
  {id:'imx', symbol:'IMX', name:'Immutable X',        price:1.14,   change24h:+3.1, bettvPick:'ALTA',   bettvConf:51, bettvReason:'Gaming blockchain líder. Parceiros AAA crescendo.', logo:'https://cryptologos.cc/logos/immutable-x-imx-logo.png',yearPick:'ALTA',yearConf:52,yearReason:'Gaming blockchain. Parceiros AAA. Meta $2.50–$4.'},
]

// ─── MOEDAS DATA ──────────────────────────────────────────────────────────────
const MOEDAS_DATA = [
  {id:'usd', symbol:'USD', name:'Dólar Americano',    flag:'🇺🇸', priceBRL:5.12,   change24h:-0.3, bettvPick:'QUEDA',  bettvConf:55, bettvReason:'Fed mantém juros. Dados de emprego abaixo do esperado.',yearPick:'NEUTRO',yearConf:60,yearReason:'Fed em pausa. DXY lateral em 100–108. Depende de dados de emprego.'},
  {id:'eur', symbol:'EUR', name:'Euro',               flag:'🇪🇺', priceBRL:5.54,   change24h:+0.4, bettvPick:'ALTA',   bettvConf:52, bettvReason:'BCE sinalizou pausa nos cortes. Zona do euro cresce.',yearPick:'ALTA',yearConf:52,yearReason:'BCE conservador. Zona do euro cresce. EUR/BRL meta R$5.80–R$6.20.'},
  {id:'gbp', symbol:'GBP', name:'Libra Esterlina',    flag:'🇬🇧', priceBRL:6.64,   change24h:+0.2, bettvPick:'ALTA',   bettvConf:50, bettvReason:'BOE conservador. Inflação UK em queda.',yearPick:'ALTA',yearConf:50,yearReason:'BOE hawkish. Inflação UK caindo. GBP/BRL meta R$6.80–R$7.20.'},
  {id:'jpy', symbol:'JPY', name:'Iene Japonês',       flag:'🇯🇵', priceBRL:0.034,  change24h:-0.5, bettvPick:'QUEDA',  bettvConf:57, bettvReason:'BOJ ainda dovish. Diferencial de juros EUA-Japão.',yearPick:'QUEDA',yearConf:55,yearReason:'BOJ ainda dovish. Diferencial juros EUA-Japão alto. JPY pressionado.'},
  {id:'cny', symbol:'CNY', name:'Yuan Chinês',        flag:'🇨🇳', priceBRL:0.707,  change24h:+0.1, bettvPick:'NEUTRO', bettvConf:48, bettvReason:'PBOC gerencia valorização. Estímulos fiscais ativos.',yearPick:'NEUTRO',yearConf:50,yearReason:'PBOC gerencia. Estímulos fiscais. USD/CNY controlado em 7.0–7.3.'},
  {id:'chf', symbol:'CHF', name:'Franco Suíço',       flag:'🇨🇭', priceBRL:5.69,   change24h:+0.3, bettvPick:'ALTA',   bettvConf:54, bettvReason:'SNB comprador de ouro. Franco seguro em risco global.',yearPick:'ALTA',yearConf:54,yearReason:'SNB comprador de ouro. Franco seguro global. CHF/BRL meta R$5.90+.'},
  {id:'cad', symbol:'CAD', name:'Dólar Canadense',    flag:'🇨🇦', priceBRL:3.72,   change24h:-0.2, bettvPick:'NEUTRO', bettvConf:46, bettvReason:'Petróleo WTI estável. BOC em pausa. CAD lateral.',yearPick:'NEUTRO',yearConf:48,yearReason:'BOC cortando juros. Petróleo volátil. CAD/BRL lateral R$3.60–R$3.90.'},
  {id:'aud', symbol:'AUD', name:'Dólar Australiano',  flag:'🇦🇺', priceBRL:3.25,   change24h:+0.6, bettvPick:'ALTA',   bettvConf:53, bettvReason:'Commodities em alta. RBA corta menos que esperado.',yearPick:'ALTA',yearConf:51,yearReason:'Commodities altas. RBA menos dovish. AUD/BRL meta R$3.30–R$3.60.'},
  {id:'brl', symbol:'BRL', name:'Real Brasileiro',    flag:'🇧🇷', priceBRL:1.00,   change24h:-0.4, bettvPick:'QUEDA',  bettvConf:56, bettvReason:'Fiscal preocupa. Copom mantém Selic 14.75%.',yearPick:'QUEDA',yearConf:58,yearReason:'Fiscal brasileiro preocupa. Selic 14.75%. BRL/USD meta R$5.50–R$6.'},
  {id:'mxn', symbol:'MXN', name:'Peso Mexicano',      flag:'🇲🇽', priceBRL:0.257,  change24h:-0.8, bettvPick:'QUEDA',  bettvConf:55, bettvReason:'Nearshoring desacelera. Banxico corta juros.',yearPick:'QUEDA',yearConf:53,yearReason:'Nearshoring desacelera. Banxico corta. MXN perde vs USD em 2026.'},
  {id:'ars', symbol:'ARS', name:'Peso Argentino',     flag:'🇦🇷', priceBRL:0.005,  change24h:-1.2, bettvPick:'QUEDA',  bettvConf:72, bettvReason:'Argentina: inflação 180% a.a. Desvalorização estrutural.',yearPick:'QUEDA',yearConf:75,yearReason:'Argentina: inflação estrutural. ARS perde valor todo ano.'},
  {id:'clp', symbol:'CLP', name:'Peso Chileno',       flag:'🇨🇱', priceBRL:0.005,  change24h:-0.3, bettvPick:'NEUTRO', bettvConf:44, bettvReason:'Cobre estável. BCCh em corte gradual.',yearPick:'NEUTRO',yearConf:45,yearReason:'Cobre suporta CLP. BCCh cortando gradual. Lateral 2026.'},
  {id:'krw', symbol:'KRW', name:'Won Coreano',        flag:'🇰🇷', priceBRL:0.019,  change24h:-0.4, bettvPick:'NEUTRO', bettvConf:45, bettvReason:'Samsung e SK Hynix em recuperação. BOK cauteloso.',yearPick:'NEUTRO',yearConf:47,yearReason:'Samsung/SK Hynix em alta mas BOK cauteloso. Lateral.'},
  {id:'inr', symbol:'INR', name:'Rúpia Indiana',      flag:'🇮🇳', priceBRL:0.061,  change24h:-0.2, bettvPick:'QUEDA',  bettvConf:50, bettvReason:'RBI intervém mas pressão estrutural no déficit.',yearPick:'QUEDA',yearConf:51,yearReason:'Déficit estrutural RBI. INR perde gradualmente vs USD.'},
  {id:'sgd', symbol:'SGD', name:'Dólar de Singapura', flag:'🇸🇬', priceBRL:3.86,   change24h:+0.2, bettvPick:'ALTA',   bettvConf:51, bettvReason:'MAS aprecia SGD. Economia de Singapura resiliente.',yearPick:'ALTA',yearConf:53,yearReason:'MAS aprecia SGD. Economia forte. SGD/BRL meta R$3.90–R$4.20.'},
  {id:'hkd', symbol:'HKD', name:'Dólar de Hong Kong', flag:'🇭🇰', priceBRL:0.658,  change24h:0.0,  bettvPick:'NEUTRO', bettvConf:95, bettvReason:'HKD atrelado ao USD. Sem variação esperada.',yearPick:'NEUTRO',yearConf:95,yearReason:'HKD atrelado ao USD. Sem variação prevista.'},
  {id:'sek', symbol:'SEK', name:'Coroa Sueca',        flag:'🇸🇪', priceBRL:0.468,  change24h:+0.4, bettvPick:'ALTA',   bettvConf:49, bettvReason:'Riksbank pausou cortes. Exportações em recuperação.',yearPick:'ALTA',yearConf:50,yearReason:'Riksbank em pausa. Exportações suecas em alta. Meta R$0.50+.'},
  {id:'nok', symbol:'NOK', name:'Coroa Norueguesa',   flag:'🇳🇴', priceBRL:0.450,  change24h:+0.3, bettvPick:'ALTA',   bettvConf:51, bettvReason:'Petróleo Brent apoia NOK. Norges Bank hawkish.',yearPick:'ALTA',yearConf:52,yearReason:'Petróleo Brent suporta NOK. Norges Bank hawkish.'},
  {id:'pln', symbol:'PLN', name:'Zloty Polonês',      flag:'🇵🇱', priceBRL:1.254,  change24h:+0.5, bettvPick:'ALTA',   bettvConf:53, bettvReason:'Polônia cresce 3.1% no 1T26. NBP conservador.',yearPick:'ALTA',yearConf:54,yearReason:'Polônia cresce 3%+. NBP conservador. PLN forte vs EUR.'},
  {id:'try', symbol:'TRY', name:'Lira Turca',         flag:'🇹🇷', priceBRL:0.147,  change24h:-1.3, bettvPick:'QUEDA',  bettvConf:70, bettvReason:'Turquia: inflação 40%+. TRY em desvalorização.',yearPick:'QUEDA',yearConf:72,yearReason:'Turquia: inflação 40%+. TRY perde valor estruturalmente.'},
  {id:'rub', symbol:'RUB', name:'Rublo Russo',        flag:'🇷🇺', priceBRL:0.056,  change24h:-0.9, bettvPick:'QUEDA',  bettvConf:66, bettvReason:'Sanções ocidentais e inflação persistente.',yearPick:'QUEDA',yearConf:68,yearReason:'Sanções + guerra. RUB em queda estrutural 2026.'},
  {id:'zar', symbol:'ZAR', name:'Rand Sul-Africano',  flag:'🇿🇦', priceBRL:0.275,  change24h:+0.7, bettvPick:'ALTA',   bettvConf:50, bettvReason:'Ouro e platina valorizam. Estabilidade política.',yearPick:'ALTA',yearConf:50,yearReason:'Ouro+platina altos. Estabilidade política. ZAR em recuperação.'},
  {id:'thb', symbol:'THB', name:'Baht Tailandês',     flag:'🇹🇭', priceBRL:0.152,  change24h:+0.2, bettvPick:'NEUTRO', bettvConf:44, bettvReason:'BOT estável. Turismo tailandês em recuperação.',yearPick:'NEUTRO',yearConf:45,yearReason:'BOT estável. Turismo crescendo. THB lateral.'},
  {id:'myr', symbol:'MYR', name:'Ringgit Malaio',     flag:'🇲🇾', priceBRL:1.142,  change24h:+0.5, bettvPick:'ALTA',   bettvConf:51, bettvReason:'BNM hawkish. Exportações semicondutores em alta.',yearPick:'ALTA',yearConf:52,yearReason:'Semicondutores em alta. BNM hawkish. MYR valoriza.'},
  {id:'aed', symbol:'AED', name:'Dirham dos EAU',     flag:'🇦🇪', priceBRL:1.393,  change24h:-0.1, bettvPick:'NEUTRO', bettvConf:90, bettvReason:'AED atrelado ao USD. Dubai estável.',yearPick:'NEUTRO',yearConf:90,yearReason:'AED atrelado ao USD. Dubai estável. Sem variação.'},
  {id:'sar', symbol:'SAR', name:'Riyal Saudita',      flag:'🇸🇦', priceBRL:1.368,  change24h:-0.1, bettvPick:'NEUTRO', bettvConf:88, bettvReason:'SAR atrelado ao USD. ARAMCO apoia reservas.',yearPick:'NEUTRO',yearConf:88,yearReason:'SAR atrelado ao USD. ARAMCO suporta. Estável.'},
  {id:'ils', symbol:'ILS', name:'Shekel Israelense',  flag:'🇮🇱', priceBRL:1.40,   change24h:-0.4, bettvPick:'NEUTRO', bettvConf:46, bettvReason:'BOI intervém. Risco geopolítico mantém volatilidade.',yearPick:'NEUTRO',yearConf:46,yearReason:'BOI intervém. Geopolítica volátil. ILS incerto.'},
  {id:'cop', symbol:'COP', name:'Peso Colombiano',    flag:'🇨🇴', priceBRL:0.001,  change24h:-0.5, bettvPick:'QUEDA',  bettvConf:51, bettvReason:'Petróleo recua. BanRep corta juros.',yearPick:'QUEDA',yearConf:52,yearReason:'Petróleo recua. BanRep corta. COP perde vs USD.'},
  {id:'pen', symbol:'PEN', name:'Sol Peruano',        flag:'🇵🇪', priceBRL:1.37,   change24h:+0.1, bettvPick:'NEUTRO', bettvConf:43, bettvReason:'Peru: mineração estável. BCRP mantém juros.',yearPick:'NEUTRO',yearConf:44,yearReason:'BCRP estável. Mineração suporta. PEN lateral.'},
  {id:'nzd', symbol:'NZD', name:'Dólar Neozelandês',  flag:'🇳🇿', priceBRL:2.96,   change24h:+0.3, bettvPick:'ALTA',   bettvConf:48, bettvReason:'RBNZ pausou cortes. Exportações agro em recuperação.',yearPick:'ALTA',yearConf:49,yearReason:'RBNZ em pausa. Agro em alta. NZD/BRL meta R$3.10+.'},
  {id:'czk', symbol:'CZK', name:'Coroa Tcheca',       flag:'🇨🇿', priceBRL:0.219,  change24h:+0.3, bettvPick:'ALTA',   bettvConf:48, bettvReason:'CNB em pausa. Economia tcheca resiliente.',yearPick:'ALTA',yearConf:49,yearReason:'CNB em pausa. Economia tcheca resiliente. CZK forte.'},
  {id:'huf', symbol:'HUF', name:'Forint Húngaro',     flag:'🇭🇺', priceBRL:0.014,  change24h:-0.6, bettvPick:'QUEDA',  bettvConf:52, bettvReason:'MNB corta juros agressivamente. HUF volátil.',yearPick:'QUEDA',yearConf:53,yearReason:'MNB corta agressivo. HUF volátil vs EUR.'},
  {id:'dkk', symbol:'DKK', name:'Coroa Dinamarquesa', flag:'🇩🇰', priceBRL:0.743,  change24h:+0.4, bettvPick:'ALTA',   bettvConf:50, bettvReason:'DKK atrelado ao EUR. Segue movimento europeu.',yearPick:'ALTA',yearConf:51,yearReason:'DKK atrelado ao EUR. Segue valorização europeia.'},
  {id:'uah', symbol:'UAH', name:'Hryvnia Ucraniana',  flag:'🇺🇦', priceBRL:0.123,  change24h:-0.6, bettvPick:'QUEDA',  bettvConf:65, bettvReason:'Ucrânia: guerra e instabilidade. UAH em queda.',yearPick:'QUEDA',yearConf:67,yearReason:'Ucrânia: guerra + instabilidade. UAH em queda estrutural.'},
  {id:'qar', symbol:'QAR', name:'Riyal Catarí',       flag:'🇶🇦', priceBRL:1.403,  change24h:0.0,  bettvPick:'NEUTRO', bettvConf:92, bettvReason:'QAR atrelado ao USD. Qatar apoia com fundo soberano.',yearPick:'NEUTRO',yearConf:92,yearReason:'QAR atrelado USD. Qatar fundo soberano. Estável.'},
  {id:'idr', symbol:'IDR', name:'Rupia Indonésia',    flag:'🇮🇩', priceBRL:0.0003, change24h:-0.4, bettvPick:'NEUTRO', bettvConf:43, bettvReason:'BI intervém para estabilizar. Comodities sustentam.',yearPick:'NEUTRO',yearConf:44,yearReason:'BI intervém. Comodities sustentam. IDR lateral.'},
  {id:'php', symbol:'PHP', name:'Peso Filipino',      flag:'🇵🇭', priceBRL:0.087,  change24h:-0.3, bettvPick:'NEUTRO', bettvConf:44, bettvReason:'BSP cortou juros. Remessas sustentam PHP.',yearPick:'NEUTRO',yearConf:45,yearReason:'BSP cortou juros. Remessas sustentam PHP.'},
  {id:'pkr', symbol:'PKR', name:'Rupia Paquistanesa', flag:'🇵🇰', priceBRL:0.018,  change24h:-0.7, bettvPick:'QUEDA',  bettvConf:64, bettvReason:'Crise de dívida. FMI empresta mas PKR fraco.',yearPick:'QUEDA',yearConf:65,yearReason:'Crise dívida. FMI emprestando. PKR fraco 2026.'},
  {id:'egp', symbol:'EGP', name:'Libra Egípcia',      flag:'🇪🇬', priceBRL:0.102,  change24h:-0.5, bettvPick:'QUEDA',  bettvConf:60, bettvReason:'CBE corta juros mas inflação persiste.',yearPick:'QUEDA',yearConf:62,yearReason:'CBE corta juros. Inflação estrutural. EGP fraco.'},
  {id:'ngn', symbol:'NGN', name:'Naira Nigeriana',    flag:'🇳🇬', priceBRL:0.003,  change24h:-1.0, bettvPick:'QUEDA',  bettvConf:68, bettvReason:'Nigéria: escassez de dólares. Inflação 28%.',yearPick:'QUEDA',yearConf:70,yearReason:'Nigéria: escassez dólares. Inflação 28%. NGN muito fraco.'},
  {id:'kwd', symbol:'KWD', name:'Dinar Kuwaitiano',   flag:'🇰🇼', priceBRL:16.85,  change24h:-0.1, bettvPick:'NEUTRO', bettvConf:85, bettvReason:'KWD mais valorizada do mundo. Atrelada ao cesto.',yearPick:'NEUTRO',yearConf:86,yearReason:'KWD mais valiosa do mundo. Cesto controlado. Estável.'},
  {id:'twd', symbol:'TWD', name:'Dólar de Taiwan',    flag:'🇹🇼', priceBRL:0.159,  change24h:+0.3, bettvPick:'ALTA',   bettvConf:52, bettvReason:'TSMC exportações recordes. Tensão China monitorada.',yearPick:'ALTA',yearConf:54,yearReason:'TSMC exportações recordes. TWD se valoriza gradualmente.'},
  {id:'bdt', symbol:'BDT', name:'Taka Bangladeshi',   flag:'🇧🇩', priceBRL:0.046,  change24h:-0.4, bettvPick:'NEUTRO', bettvConf:42, bettvReason:'Bangladesh: exportações têxteis estáveis.',yearPick:'NEUTRO',yearConf:43,yearReason:'Bangladesh: têxteis estáveis. BDT lateral.'},
  {id:'kes', symbol:'KES', name:'Shilling Queniano',  flag:'🇰🇪', priceBRL:0.040,  change24h:+0.3, bettvPick:'NEUTRO', bettvConf:45, bettvReason:'Quênia: inflação em queda. KES em recuperação.',yearPick:'NEUTRO',yearConf:46,yearReason:'Quênia: inflação em queda. KES em leve recuperação.'},
  {id:'jod', symbol:'JOD', name:'Dinar Jordaniano',   flag:'🇯🇴', priceBRL:7.22,   change24h:0.0,  bettvPick:'NEUTRO', bettvConf:88, bettvReason:'JOD atrelado ao USD. CBJ defende paridade.',yearPick:'NEUTRO',yearConf:88,yearReason:'JOD atrelado USD. CBJ defende paridade. Estável.'},
  {id:'omr', symbol:'OMR', name:'Rial Omanense',      flag:'🇴🇲', priceBRL:13.29,  change24h:-0.1, bettvPick:'NEUTRO', bettvConf:85, bettvReason:'OMR atrelado ao USD. Petróleo sustenta reservas.',yearPick:'NEUTRO',yearConf:86,yearReason:'OMR atrelado USD. Petróleo sustenta. Estável.'},
  {id:'bam', symbol:'BAM', name:'Marco Bósnio',       flag:'🇧🇦', priceBRL:2.83,   change24h:+0.4, bettvPick:'ALTA',   bettvConf:49, bettvReason:'BAM atrelado ao EUR. Segue valorização europeia.',yearPick:'ALTA',yearConf:50,yearReason:'BAM atrelado EUR. Segue valorização europeia.'},
  {id:'vnd', symbol:'VND', name:'Dong Vietnamita',    flag:'🇻🇳', priceBRL:0.0002, change24h:0.0,  bettvPick:'NEUTRO', bettvConf:80, bettvReason:'SBV gerencia câmbio. VND quasi-fixo ao USD.',yearPick:'NEUTRO',yearConf:80,yearReason:'SBV gerencia câmbio. VND quasi-fixo ao USD.'},
  {id:'myr2',symbol:'SGD', name:'Dólar de Singapura 2',flag:'🇸🇬',priceBRL:3.86,   change24h:+0.2, bettvPick:'ALTA',   bettvConf:51, bettvReason:'MAS aprecia SGD. Economia resiliente.',yearPick:'ALTA',yearConf:51,yearReason:'SGD: MAS aprecia. Economia Singapura resiliente.'},
]
